...
function createSection1(p_output, p_aObjDef)
{
	...
	for(var i=0; i<p_aObjDef.length; i++) {
		p_output.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
		writeData(p_output, p_aObjDef[i].GUID())
	...
	*/
	...
	if( isExcel() ) {
		p_output.EndTable(getString("ID_REPORTDEF_6"), 100, "", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_LEFT, 0)
		xlTableActive=false
	}
	p_output.EndSection()
