...
var selectedObjOcc = ArisData.getSelectedObjOccs()



var objDefsSlave = new Array()
for(var i=0;i<selectedObjOcc.length;i++){
    objDefsSlave.push(selectedObjOcc[i].ObjDef())
}
...
var objDefsMaster = targetGroup.ObjDefListFilter(Constants.OT_ENT_TYPE)
