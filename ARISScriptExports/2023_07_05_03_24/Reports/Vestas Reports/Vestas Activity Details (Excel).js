...
function printRowHeaders(pExcelWorkBook) {
    ...
    lMainSheet.setColumnWidth(22, giStandardColumnWidth);
      
    lMainSheet.setColumnWidth(23, giStandardColumnWidth);
    ...
    lCell6.setCellValue("Output");
    
    var lCell7 = lHeaderRow.createCell(6);
    lCell7.setCellValue("Output RASCI");
    
    var lCell8 = lHeaderRow.createCell(7);
    lCell8.setCellValue("Input - Output description");
    var lCell9 = lHeaderRow.createCell(8);
    lCell9.setCellValue("Supporting Systems");
    var lCell10 = lHeaderRow.createCell(9);
    lCell10.setCellValue("R - Responsible");
    var lCell11 = lHeaderRow.createCell(10);
    lCell11.setCellValue("A - Accountable");
    var lCell12 = lHeaderRow.createCell(11);
    lCell12.setCellValue("S - Supported by");
    var lCell13 = lHeaderRow.createCell(12);
    lCell13.setCellValue("C - Consulted for");
    var lCell14 = lHeaderRow.createCell(13);
    lCell14.setCellValue("I - Informed of");

    var lCell15 = lHeaderRow.createCell(14);
    lCell15.setCellValue("Title1");
    var lCell16 = lHeaderRow.createCell(15);
    lCell16.setCellValue("Link1");
    var lCell17 = lHeaderRow.createCell(16);
    lCell17.setCellValue("Title2");
    var lCell18 = lHeaderRow.createCell(17);
    lCell18.setCellValue("Link2");
    var lCell19 = lHeaderRow.createCell(18);
    lCell19.setCellValue("Title3");
    var lCell20 = lHeaderRow.createCell(19);
    lCell20.setCellValue("Link3");
    var lCell21 = lHeaderRow.createCell(20);
    lCell21.setCellValue("Title4");
    var lCell22 = lHeaderRow.createCell(21);
    lCell22.setCellValue("Link4");
    //changed 08/07/2019
    var lCell23 = lHeaderRow.createCell(22);
    lCell23.setCellValue("SAP T-Codes Full name");
    var lCell24 = lHeaderRow.createCell(23);
    lCell24.setCellValue("SAP T-Codes");
    ...
    try {
        ...
        for (var i = 0; i < laObjOcc.length; i++) {
            ...
            if (laObjOcc[i].ObjDef().TypeNum().toString().equalsIgnoreCase("22") &&
                ...
                //CUSTOM 07092020
                var laResultsAccountable = getRelatedOccurrence(laObjOcc[i], Constants.CT_DECD_ON, Constants.OT_PERS_TYPE, null); // is accountable for		CT_DECD_ON Person type (78)	OT_PERS_TYPE 
                ...
                //CUSTOM 07092020
                var laResultsSupported = getRelatedOccurrence(laObjOcc[i], Constants.CT_CONTR_TO_2, Constants.OT_PERS_TYPE, null); // is supportingCT_CONTR_TO_2 Person type (78)	OT_PERS_TYPE
                ...
                if (lmAssignedFAD != null) {
                    ...
                    if (loOccurrenceOnFAD != null) {
                        ...
                        //CUSTOM 07092020
                        laResultsAccountable = getRelatedOccurrence(loOccurrenceOnFAD[0], Constants.CT_DECD_ON, Constants.OT_PERS_TYPE, laResultsAccountable); // is accountable for		CT_DECD_ON Person type (78)	OT_PERS_TYPE
                        ...
                        //CUSTOM 07092020
                        laResultsSupported = getRelatedOccurrence(loOccurrenceOnFAD[0], Constants.CT_CONTR_TO_2, Constants.OT_PERS_TYPE, laResultsSupported); // is supporting		CT_CONTR_TO_2 Person type (78)	OT_PERS_TYPE
                        ...
                        var laResultsOutputs = getRelatedOccurrenceOcc(loOccurrenceOnFAD[0], Constants.CT_HAS_OUT, Constants.OT_TECH_TRM, null); // CT_HAS_OUT Technical Term (58) API OT_TECH_TRM
                        for each(resultOutput in laResultsOutputs) {
                            lsOutput = resultOutput.ObjDef().Name(giLoc);

                            var outputRasci = new Array() 
                            //get ConnectedRole obj
                            var rolesR = getRelatedOccurrenceOcc(resultOutput, Constants.CT_EXEC_2, Constants.OT_PERS_TYPE, null);
                            outputRasci = outputRasci.concat(getRasciString(rolesR, "R"))
                            var rolesA = getRelatedOccurrenceOcc(resultOutput, Constants.CT_DECD_ON, Constants.OT_PERS_TYPE, null);
                            outputRasci = outputRasci.concat(getRasciString(rolesA, "A"))
                            var rolesS = getRelatedOccurrenceOcc(resultOutput, Constants.CT_CONTR_TO_2, Constants.OT_PERS_TYPE, null);
                            outputRasci = outputRasci.concat(getRasciString(rolesS, "S"))
                            var rolesC = getRelatedOccurrenceOcc(resultOutput, Constants.CT_HAS_CONSLT_ROLE_IN_2, Constants.OT_PERS_TYPE, null);
                            outputRasci = outputRasci.concat(getRasciString(rolesC, "C"))
                            var rolesI = getRelatedOccurrenceOcc(resultOutput, Constants.CT_MUST_BE_INFO_ABT_2, Constants.OT_PERS_TYPE, null);
                            outputRasci = outputRasci.concat(getRasciString(rolesI, "I"))
                            
                            //array to string
                            var outputRasciStr = arrayToString(outputRasci)
                            
                            lsInputOutputDescription = getItemAttributeValue(resultOutput.ObjDef(), 9, "");
                            printRow(psModelName, lsActivityName, lsActivityDescription, "", "", lsOutput, outputRasciStr, lsInputOutputDescription, lsApplicationSystemTypeName, lsResponsibleName, lsAccountableName, lsSupportedName, lsConsultedName, lsInformedName, lsTitle1, lsLink1, lsTitle2, lsLink2, lsTitle3, lsLink3, lsTitle4, lsLink4, lsSAPNames, lsSAPFullNames, pExcelWorkBook, rowColorBr, outputRasciStr);
                            funcBr++;
                        ...
                        laResultsOutputs = getRelatedOccurrenceOcc(loOccurrenceOnFAD[0], Constants.CT_IS_INP_FOR, Constants.OT_TECH_TRM, null); // CT_IS_INP_FOR Technical Term (58) API OT_TECH_TRM
                        for each(resultOutput in laResultsOutputs) {
                            lsInput = resultOutput.ObjDef().Name(giLoc);
                            
                            var inputRasci = new Array() 
                            //get ConnectedRole obj
                            var rolesR = getRelatedOccurrenceOcc(resultOutput, Constants.CT_EXEC_2, Constants.OT_PERS_TYPE, null);
                            inputRasci = inputRasci.concat(getRasciString(rolesR, "R"))
                            var rolesA = getRelatedOccurrenceOcc(resultOutput, Constants.CT_DECD_ON, Constants.OT_PERS_TYPE, null);
                            inputRasci = inputRasci.concat(getRasciString(rolesA, "A"))
                            var rolesS = getRelatedOccurrenceOcc(resultOutput, Constants.CT_CONTR_TO_2, Constants.OT_PERS_TYPE, null);
                            inputRasci = inputRasci.concat(getRasciString(rolesS, "S"))
                            var rolesC = getRelatedOccurrenceOcc(resultOutput, Constants.CT_HAS_CONSLT_ROLE_IN_2, Constants.OT_PERS_TYPE, null);
                            inputRasci = inputRasci.concat(getRasciString(rolesC, "C"))
                            var rolesI = getRelatedOccurrenceOcc(resultOutput, Constants.CT_MUST_BE_INFO_ABT_2, Constants.OT_PERS_TYPE, null);
                            inputRasci = inputRasci.concat(getRasciString(rolesI, "I"))
                            
                            //array to string
                            var inputRasciStr = arrayToString(inputRasci)

                            lsInputOutputDescription = getItemAttributeValue(resultOutput.ObjDef(), 9, "");
                            printRow(psModelName, lsActivityName, lsActivityDescription, lsInput, inputRasciStr, "", "", lsInputOutputDescription, lsApplicationSystemTypeName, lsResponsibleName, lsAccountableName, lsSupportedName, lsConsultedName, lsInformedName, lsTitle1, lsLink1, lsTitle2, lsLink2, lsTitle3, lsLink3, lsTitle4, lsLink4, lsSAPNames, lsSAPFullNames, pExcelWorkBook, rowColorBr);
                            funcBr++;
                            // save print status Input/output
                            lsInputOutputFound = true;
                        }
...
function getRelatedOccurrenceOcc(pObjOcc, piCnxTypeNum, piTargetTypeNum, paMergeResult) {
    var laFoundRelatedObjects = new Array();
    // if parameter array contains objects, use it for collection results
    if (paMergeResult != null) {
        laFoundRelatedObjects = paMergeResult;
            ...
            if (connectionOcc.CxnDef().TypeNum() == piCnxTypeNum) {
                ...
                if (targetOcc.ObjDef().Name(giLoc).equalsIgnoreCase(pObjOcc.ObjDef().Name(giLoc)) == false) {
                    ...
                    if (targetOcc.ObjDef().TypeNum() == piTargetTypeNum) {
                        ...
                        laFoundRelatedObjects[laFoundRelatedObjects.length] = targetOcc;
                    }
                } else {
                    targetOcc = connectionOcc.TargetObjOcc();
                    if (targetOcc.ObjDef().Name(giLoc).equalsIgnoreCase(pObjOcc.ObjDef().Name(giLoc)) == false) {
...
function printRow(psModelName, psActivityName, psActivityDescription, psInput, psInputRasci, psOutput, psOutputRasci, psInputOutputDescription, psApplicationSystemTypeName, psResponsibleName, psAccountableName, psSupportedName, psConsultedName, psInformedName, psTitle1, psLink1, psTitle2, psLink2, psTitle3, psLink3, psTitle4, psLink4, psSAPNames, psSAPFullNames, pExcelWorkBook, rowColorBr) {
    try {
        ...
        // Input RASCI
        var lCellDesc = lModelRow.createCell(4);
        lCellDesc.setCellValue(psInputRasci);
        ...
        lCellDesc.setCellValue(psOutputRasci);
        lCellDesc.setCellStyle(crDataRowStyle);
        ...
        //changed 08/07/2019
        // SAP Full Names
        var lCellDesc = lModelRow.createCell(22);
        lCellDesc.setCellValue(psSAPFullNames);
        lCellDesc.setCellStyle(crDataRowStyle);
        
        // SAP Names
        var lCellDesc = lModelRow.createCell(23);
        lCellDesc.setCellValue(psSAPNames);
        lCellDesc.setCellStyle(crDataRowStyle);
        
        // Output RASCI
        var lCellDesc = lModelRow.createCell(24);
        lCellDesc.setCellValue(psOutputRasci);
        lCellDesc.setCellStyle(crDataRowStyle);
...
function getRasciString(roles, rasciMark){
    var rasciStr = new Array()
    for(var i=0; i<roles.length; i++){
    
    var tempStr = rasciMark + "-" + roles[i].ObjDef().Name(giLoc) + " \r\n"
    
    rasciStr.push(tempStr)
    }
