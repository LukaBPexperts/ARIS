...
function main(){
    ...
    if (selectedDatabase.Name(nLocale) != publishDBName) {
        ...
        //Simulation dialog
        //var btnPressed = Dialogs.MsgBox("You are about to start cleanup script!\nPress NO if you want to run simulation, without making any changes", Constants.MSGBOX_ICON_QUESTION | Constants.MSGBOX_BTN_YESNO + 512, "Message from Report") //comment to disable simualtion
        var btnPressed = Constants.MSGBOX_RESULT_YES //uncomment to disable simulation
