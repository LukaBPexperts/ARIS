...
function createSection2(p_output, p_aModel)
{
	...
	for(var i=0; i<p_aModel.length; i++) {
		...
		iteration_section2(p_output, ArisData.sort(p_aModel[i].ObjOccListFilter(Constants.OT_FUNC),Constants.SORT_Y,Constants.SORT_X, nLocale))
	}
	...
	// createSection2 local functions:
		...
		*/
		function iteration_section(p_output, p_Attr)
		{
			//produce one table sheet per section
			if(xlTableActive && isExcel()) {
				p_output.EndTable(getString("ID_REPORTDEF_34"), 100, "", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_LEFT, 0)
				xlTableActive=false
			}
			p_output.BeginSection(false, Constants.SECTION_DEFAULT)
			sectionPageSetup( p_output )
			...
			writeData2(p_output, p_aModel[i].Graphic(false, false, nLocale, true))
		...
		*/
		function iteration_section1(p_output, p_Attr)
		{
			...
			if( !isExcel() )
				...
				writeData9(p_output, p_aModel[i].Attribute(ArisData.ActiveFilter().UserDefinedAttributeTypeNum("8fda52b0-6188-11de-4732-00237d347a8a"), nLocale))
				p_output.EndParagraph()
			if( !isExcel() )
			...
			p_output.OutputLn(getString("ID_REPORTDEF_16"), getString("ID_DEFAULT_FONT"), 12, RGB(0,0,0), Constants.C_TRANSPARENT,  Constants.FMT_BOLD  |  Constants.FMT_LEFT, 0)
			p_output.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
			writeData10(p_output, p_aModel[i].Attribute(Constants.AT_NAME, nLocale))
			p_output.EndParagraph()
			p_output.OutputLnF("", getString("ID_STYLE_RD_DEFAULT"))
			...
			p_output.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
			writeData11(p_output, p_aModel[i].Attribute(ArisData.ActiveFilter().UserDefinedAttributeTypeNum("c4648a80-a28f-11de-4732-00237d347a8a"), nLocale))
			p_output.EndParagraph()
			p_output.OutputLnF("", getString("ID_STYLE_RD_DEFAULT"))
			...
			p_output.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
			writeData12(p_output, p_aModel[i].Attribute(Constants.AT_DESC, nLocale))
			p_output.EndParagraph()
			p_output.OutputLnF("", getString("ID_STYLE_RD_DEFAULT"))
			...
			p_output.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
			writeData13(p_output, p_aModel[i].Attribute(ArisData.ActiveFilter().UserDefinedAttributeTypeNum("cb2e9410-ecd9-11df-21f4-00237d347a8a"), nLocale))
			p_output.EndParagraph()
			p_output.OutputLnF("", getString("ID_STYLE_RD_DEFAULT"))
			...
			p_output.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
			writeData14(p_output, p_aModel[i].Attribute(ArisData.ActiveFilter().UserDefinedAttributeTypeNum("e8a5da20-a28f-11de-4732-00237d347a8a"), nLocale))
			p_output.EndParagraph()
			p_output.OutputLnF("", getString("ID_STYLE_RD_DEFAULT"))
			...
			p_output.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
			writeData15(p_output, p_aModel[i].Attribute(ArisData.ActiveFilter().UserDefinedAttributeTypeNum("4a526e00-a290-11de-4732-00237d347a8a"), nLocale))
			p_output.EndParagraph()
			p_output.OutputLnF("", getString("ID_STYLE_RD_DEFAULT"))
			...
			p_output.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
			writeData16(p_output, p_aModel[i].Attribute(ArisData.ActiveFilter().UserDefinedAttributeTypeNum("59d18ff0-a290-11de-4732-00237d347a8a"), nLocale))
			p_output.EndParagraph()
			p_output.OutputLnF("", getString("ID_STYLE_RD_DEFAULT"))
			...
			p_output.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
			writeData17(p_output, p_aModel[i].Attribute(ArisData.ActiveFilter().UserDefinedAttributeTypeNum("ad4098b0-3021-11df-4732-00237d347a8a"), nLocale))
			p_output.EndParagraph()
			p_output.OutputLnF("", getString("ID_STYLE_RD_DEFAULT"))
			...
			p_output.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
			writeData18(p_output, p_aModel[i].Attribute(ArisData.ActiveFilter().UserDefinedAttributeTypeNum("71fc3d00-a290-11de-4732-00237d347a8a"), nLocale))
			p_output.EndParagraph()
			p_output.OutputLnF("", getString("ID_STYLE_RD_DEFAULT"))
			...
			p_output.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
			writeData19(p_output, p_aModel[i].Attribute(ArisData.ActiveFilter().UserDefinedAttributeTypeNum("d2a555a0-c334-11de-4732-00237d347a8a"), nLocale))
			p_output.EndParagraph()
			p_output.OutputLnF("", getString("ID_STYLE_RD_DEFAULT"))
			...
			p_output.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
			writeData20(p_output, p_aModel[i].Attribute(ArisData.ActiveFilter().UserDefinedAttributeTypeNum("16b5b110-a290-11de-4732-00237d347a8a"), nLocale))
			p_output.EndParagraph()
			p_output.OutputLnF("", getString("ID_STYLE_RD_DEFAULT"))
			...
			p_output.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
			writeData21(p_output, p_aModel[i].Attribute(Constants.AT_TITL1, nLocale).GetValue(false))
			p_output.EndParagraph()
			p_output.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
			writeData22(p_output, p_aModel[i].Attribute(Constants.AT_EXT_1, nLocale).GetValue(false))
			p_output.EndParagraph()
			p_output.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
			writeData23(p_output, p_aModel[i].Attribute(Constants.AT_TITL2, nLocale).GetValue(false))
			p_output.EndParagraph()
			p_output.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
			writeData24(p_output, p_aModel[i].Attribute(Constants.AT_EXT_2, nLocale).GetValue(false))
			p_output.EndParagraph()
			p_output.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
			writeData25(p_output, p_aModel[i].Attribute(Constants.AT_TITL3, nLocale).GetValue(false))
			p_output.EndParagraph()
			p_output.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
			writeData26(p_output, p_aModel[i].Attribute(Constants.AT_EXT_3, nLocale).GetValue(false))
			p_output.EndParagraph()
			p_output.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
			writeData27(p_output, p_aModel[i].Attribute(Constants.AT_TITL4, nLocale).GetValue(false))
			p_output.EndParagraph()
			p_output.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
			writeData28(p_output, p_aModel[i].Attribute(Constants.AT_LINK, nLocale).GetValue(false))
			p_output.EndParagraph()
		...
		*/
		function iteration_section2(p_output, p_aObjOcc)
		{
			...
			p_output.OutputLn(getString("ID_REPORTDEF_28"), getString("ID_DEFAULT_FONT"), 14, RGB(0,0,0), Constants.C_TRANSPARENT,  Constants.FMT_BOLD  |  Constants.FMT_LEFT, 0)
			p_output.OutputLnF("", getString("ID_STYLE_RD_DEFAULT"))
			// repetition of queried data:
			for(var i1=0; i1<p_aObjOcc.length; i1++) {
				p_output.BeginParagraph( Constants.FMT_LEFT, 0, 0, 0, 0, 0)
				writeData30(p_output, p_aObjOcc[i1].getObjDefName(nLocale))
				p_output.EndParagraph()
				p_output.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
				writeData31(p_output, p_aObjOcc[i1].ObjDef().Attribute(Constants.AT_DESC, nLocale))
				p_output.EndParagraph()
			...
			*/
			 ...
			 * @param {Attr } p_Attr
			*/
			function writeData31(p_output, p_Attr) {
				p_output.OutputLn(p_Attr.getValue(), getString("ID_DEFAULT_FONT"), 12, RGB(0,0,0), Constants.C_TRANSPARENT,  Constants.FMT_LEFT, 0)
			}
				/**
				 * @param {Output} p_output The output object
				...
				function dtable(p_output, p_aCxnDef)
				{
					...
					for(var i2=0; i2<p_aCxnDef.length; i2++) {
						p_output.TableRow()
							...
							p_output.TableCell("", 50.62, getString("ID_DEFAULT_FONT"), 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0,  Constants.FMT_VTOP |  Constants.FMT_LEFT, 0)
						p_output.OutputLn(getString("ID_REPORTDEF_29"), getString("ID_DEFAULT_FONT"), 12, RGB(0,0,0), Constants.C_TRANSPARENT,  Constants.FMT_LEFT, 12.70)
							p_output.TableCell("", 49.38, getString("ID_DEFAULT_FONT"), 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0,  Constants.FMT_VTOP |  Constants.FMT_LEFT, 0)
						p_output.BeginParagraph( Constants.FMT_LEFT, 0.71, 0.71, 0, 0, 0)
						writeData32(p_output, p_aCxnDef[i2].SourceObjDef().Name(nLocale))
						p_output.EndParagraph()
					}
					ArisData.getActiveDatabase().clearCaches()
					 ...
					 * @param {String } p_String
					*/
					function writeData32(p_output, p_String) {
				...
				*/
				function dtable1(p_output, p_aAttr)
				{
					...
					if( !isExcel() )
						p_output.BeginTable(100, Constants.C_TRANSPARENT, Constants.C_TRANSPARENT,  Constants.FMT_LEFT | Constants.FMT_NOBORDER, 0)
					// repetition of queried data:
				...
				*/
				function dtable5(p_output, p_aAttr)
				{
					...
					p_output.TableRow()
						...
						p_output.SetFrameStyle( Constants.FRAME_BOTTOM, 0, 0)
						p_output.SetFrameStyle( Constants.FRAME_RIGHT, 0, 0)
						p_output.TableCell("", 100, getString("ID_DEFAULT_FONT"), 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0,  Constants.FMT_VTOP |  Constants.FMT_LEFT, 0)
					p_output.OutputLn(getString("ID_REPORTDEF_27"), getString("ID_DEFAULT_FONT"), 12, RGB(0,0,0), Constants.C_TRANSPARENT,  Constants.FMT_UNDERLINE  |  Constants.FMT_LEFT, 0)
					// repetition of queried data:
					for(var i2=0; i2<p_aAttr.length; i2++) {
						p_output.TableRow()
							p_output.ResetFrameStyle()
					...
					outputObj.BeginHeader()
						if( !isExcel() )
							...
							outputObj.TableRow()
								...
								outputObj.TableCell("", 67.1, getString("ID_DEFAULT_FONT"), 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0,  Constants.FMT_VTOP |  Constants.FMT_CENTER, 0)
							outputObj.BeginParagraph( Constants.FMT_CENTER, 0.71, 0.71, 0, 0, 0)
							writeData29(outputObj, p_aModel[i].Name(nLocale))
							outputObj.EndParagraph()
								outputObj.TableCell("", 32.99, getString("ID_DEFAULT_FONT"), 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0,  Constants.FMT_VTOP |  Constants.FMT_RIGHT, 0)
							outputObj.BeginParagraph( Constants.FMT_RIGHT, 1, 1, 0, 0, 0)
														var image = Context.createPicture("vestas.png")
