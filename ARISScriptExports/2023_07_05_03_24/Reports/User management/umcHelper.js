...
function writeSubTitle(text, colspan) {
    g_Output.TableCell(text, 1, colspan, getString("ID_DEFAULT_FONT"), 14, setColor(0, 133, 173), Constants.C_WHITE, 0, Constants.FMT_VTOP | Constants.FMT_LEFT | Constants.FMT_BOLD, 0);
}

function writeSubTitleLevelTwo(text, colspan) {
    g_Output.TableCell(text, 1, colspan, getString("ID_DEFAULT_FONT"), 12, setColor(0, 133, 173), Constants.C_WHITE, 0, Constants.FMT_VTOP | Constants.FMT_LEFT | Constants.FMT_BOLD, 0);
}
