...
{  
    ...
    g_ooutfile.value.TableRow();
    g_ooutfile.value.TableCell("Order No.", 21, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
    g_ooutfile.value.TableCell(oFunctionDef.Attribute(Constants.AT_USER_ATTR5,g_nloc).GetValue(true), 79, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
    ...
    g_ooutfile.value.TableRow();
    g_ooutfile.value.TableCell("Name", 21, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
    g_ooutfile.value.TableCell(oFunctionDef.Attribute(Constants.AT_NAME,g_nloc).GetValue(true), 79, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
    
    g_ooutfile.value.TableRow();
    g_ooutfile.value.TableCell("Long Description", 21, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
    g_ooutfile.value.TableCell(oFunctionDef.Attribute(Constants.AT_DESC,g_nloc).GetValue(true), 79, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
    
    g_ooutfile.value.TableRow();
    g_ooutfile.value.TableCell("Control frequency", 21, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
    g_ooutfile.value.TableCell(oFunctionDef.Attribute(Constants.AT_AAM_CTRL_FREQUENCY,g_nloc).GetValue(true), 79, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
    
    g_ooutfile.value.TableRow();
    g_ooutfile.value.TableCell("Control type", 21, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
    g_ooutfile.value.TableCell(oFunctionDef.Attribute(Constants.AT_AAM_CTRL_EFFECT,g_nloc).GetValue(true), 79, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
    
    g_ooutfile.value.TableRow();
    g_ooutfile.value.TableCell("Control evidence", 21, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
    g_ooutfile.value.TableCell(oFunctionDef.Attribute(Constants.AT_UA_TXT_100,g_nloc).GetValue(true), 79, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
    
    g_ooutfile.value.TableRow();
    g_ooutfile.value.TableCell("Type (control)", 21, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
    g_ooutfile.value.TableCell(oFunctionDef.Attribute(Constants.AT_UA_VAL_221,g_nloc).GetValue(true), 79, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
    
    g_ooutfile.value.TableRow();
    g_ooutfile.value.TableCell("Control ID", 21, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
    g_ooutfile.value.TableCell(oFunctionDef.Attribute(Constants.AT_AAM_CTRL_ID,g_nloc).GetValue(true), 79, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
    
    g_ooutfile.value.TableRow();
    g_ooutfile.value.TableCell("Key control", 21, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
    g_ooutfile.value.TableCell(oFunctionDef.Attribute(Constants.AT_AAM_KEY_CTRL,g_nloc).GetValue(true), 79, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
...
function writeEventInfo(objEvent, txtEventStatus)
{
    ...
    g_ooutfile.value.TableRow();
    g_ooutfile.value.TableCell("Name", 21, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
    g_ooutfile.value.TableCell(objEvent.Attribute(Constants.AT_NAME,g_nloc).GetValue(true), 79, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
...
function writeEventsInfo(objEvents, txtEventStatus, objPrecOperator)
{
    ...
    else
    {
        ...
        g_ooutfile.value.TableRow();
        g_ooutfile.value.TableCell("Name", 21, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
        g_ooutfile.value.TableCell(text, 79, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
...
function writeApplications(p_Object, blnTextColor)
{
    ...
    {
        g_ooutfile.value.TableRow();
        g_ooutfile.value.TableCell("Application/Media", 21, getString("TEXT48"), 12, blnTextColor, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
	    ...
	    for(var index=0; index<objConnectedApplicationsList.length; index++) 
        {
            ...
            if(index==0)
            {
                g_ooutfile.value.TableCell(outText, 79, getString("TEXT48"), 12, blnTextColor, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
            }
            else
            {
                g_ooutfile.value.TableRow();
                g_ooutfile.value.TableCell("", 21, getString("TEXT48"), 12, blnTextColor, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
	            g_ooutfile.value.TableCell(outText, 79, getString("TEXT48"), 12, blnTextColor, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
            }
        }
    }
...
function writeOrgUnitsPositions(p_Object, blnTextColor) 
{
    ...
    {
        g_ooutfile.value.TableRow();
        g_ooutfile.value.TableCell("Organizational unit/Position", 21, getString("TEXT48"), 12, blnTextColor, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
...
function writeInputDocs(p_Object, blnTextColor) 
{
    ...
    {
        g_ooutfile.value.TableRow();
        g_ooutfile.value.TableCell("Input documents", 21, getString("TEXT48"), 12, blnTextColor, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
...
function writeOutputDocs(p_Object, blnTextColor) 
{
    ...
    {
        g_ooutfile.value.TableRow();
        g_ooutfile.value.TableCell("Output documents", 21, getString("TEXT48"), 12, blnTextColor, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
...
function writeRisks(p_Object, blnTextColor) 
{
    ...
    {
        g_ooutfile.value.TableRow();
        g_ooutfile.value.TableCell("Risks", 21, getString("TEXT48"), 12, blnTextColor, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
...
function writeDetails(p_Object, blnTextColor) 
{
    ...
    {
        g_ooutfile.value.TableRow();
        g_ooutfile.value.TableCell("Comment", 21, getString("TEXT48"), 12, blnTextColor, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
...
function outputmodeldata_std(ocurrentmodel, ncurrentdepth, nmodellevel, ssourcefunc, bfirstmodel)
{
  ...
  g_ooutfile.value.TableRow();
  g_ooutfile.value.TableCell("Type", 21, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
  g_ooutfile.value.TableCell(ocurrentmodel.value.Type(), 79, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
  
  g_ooutfile.value.TableRow();
  g_ooutfile.value.TableCell("Name", 21, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
  g_ooutfile.value.TableCell(ocurrentmodel.value.Attribute(Constants.AT_NAME, g_nloc).GetValue(true), 79, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
  
  g_ooutfile.value.TableRow();
  g_ooutfile.value.TableCell("Long Description", 21, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
  g_ooutfile.value.TableCell(ocurrentmodel.value.Attribute(Constants.AT_DESC, g_nloc).GetValue(false), 79, getString("TEXT48"), 12, Constants.C_BLACK, Constants.C_WHITE, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
