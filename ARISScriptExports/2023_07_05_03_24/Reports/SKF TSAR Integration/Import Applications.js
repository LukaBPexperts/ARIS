...
g_mapTable.push(["PPM ID", "da908eb1-2687-11ec-4841-0a5f6f9452ec"]);    //PPM ID
g_mapTable.push(["Name", Constants.AT_NAME]);                           //Name
...
----------------------------------------------------------------------------- */
var g_applicationID = "PPM ID";                                                          //system ID column header in import file, used for matching system between ARIS and PPM

//Only update existing or also create new
var g_updateOnly = true; //If set to true it will only update existing applications. When set to false will create new objects

/* ----------General settings-------------------------------------
 Definitions for settings needed by the script.
 E.g. which attribute is used for indicating import status
--------------------------------------------------------------- */                                                 
var g_applicationGroupPath = "Main group/0 Enterprise Object Library/IT Systems";                       //Group path for objects
...
var g_applicationObjSymbolType = Constants.ST_APPL_SYS_TYPE;                             //IT system symbol type
var g_applicationModelName = "NEW IT SYSTEM LIBRARY (PPM)";                                    //Name of system library model
var g_applicationModelType = "447983e1-042a-11e5-2959-68b599cb13d7"//Constants.MT_APPL_SYS_TYPE_DGM;              //system landscape model
