...
function INIT_Configuration() {
    ...
    g_hmTypeMapping[Constants.OT_PERS_TYPE] = Constants.MT_ROLE_DGM; // ROLE Object mapping
    g_hmTypeMapping[Constants.OT_CLS] = ArisData.ActiveFilter().UserDefinedModelTypeNum("403a3eb1-176a-11e6-6fc6-005056a95aef"); // Interface Object mapping (Interface Library model type)
