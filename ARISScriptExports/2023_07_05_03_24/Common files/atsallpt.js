...
function graphicdialogs(g_ooutfile, bcheckuserdialog)
{
  ...
  if (bcheckuserdialog.value) {
    ...
    while (binput == false) {
      var userdialog = Dialogs.createNewDialogTemplate(700, 310, "Formatar gráfico", "GraphicDialogsFunc_Dlg1");      
      // %GRID:10,7,1,1
      userdialog.Text(10, 10, 460, 15, "Utilize as seguintes opções para exibir o gráfico do modelo.");
      userdialog.Text(10, 25, 460, 15, "Clique em OK para finalizar sua seleção.");
      userdialog.GroupBox(7, 50, 686, 55, "Cor");
      userdialog.OptionGroup("options1");
      userdialog.OptionButton(20, 65, 580, 15, "Colorido");
      userdialog.OptionButton(20, 80, 580, 15, "Preto e branco");
      ...
      userdialog.OptionButton(20, 135, 180, 15, "Definido pelo usuário");
      userdialog.OptionButton(20, 150, 80, 15, "100%");
      userdialog.OptionButton(20, 165, 580, 15, "Dimensionar para ajustar ao tamanho da página");
      userdialog.OptionButton(20, 182, 660, 15, "Escala de impresão do modelo");
      userdialog.GroupBox(7, 220, 686, 55, "Recortar");
      userdialog.OptionGroup("options4");
      userdialog.OptionButton(20, 235, 580, 15, "Cortar obejtos nas margens");
      userdialog.OptionButton(20, 250, 580, 15, "Sobrepor objetos além das margens");
      userdialog.OKButton();
        ...
        if ( !(isNaN(dlg.getDlgText("Text0"))) ) {
          ...
          if (nscalevalue.value >= 10 && nscalevalue.value <= 400) {    // BLUE-10197 Adapted to the allowed values in Designer 
            binput = true;
                        ...
                        Dialogs.MsgBox("Digite uma medida < 400.", 0, "Relatório");
          }

        }
        else {
                    Dialogs.MsgBox("Digite uma medida.", 0, "Relatório");
        }
    ...
    if (! (nuserdlg1 == 0)) {
      ...
      // (No page settings for HTML output)
        ...
        while (binput == false) {
          ...
          var userdialog = Dialogs.createNewDialogTemplate(520, 280, "Relatório", "GraphicDialogsFunc_Dlg3");       // %GRID:10,7,1,1
          userdialog.Text(10, 10, 460, 15, "Selecione o layout da página.");
          userdialog.Text(10, 25, 460, 15, "Clique em OK para finalizar sua seleção.");
          userdialog.GroupBox(10, 49, 240, 180, "Margens");
          userdialog.Text(20, 70, 100, 15, "Superior");
          userdialog.TextBox(120, 67, 40, 20, "Text0");
          userdialog.Text(170, 70, 25, 15, "mm");
          userdialog.Text(20, 100, 100, 15, "Inferior");
          userdialog.TextBox(120, 97, 40, 20, "Text2");
          userdialog.Text(170, 100, 25, 15, "mm");
          userdialog.Text(20, 130, 100, 15, "Para a esquerda");
          userdialog.TextBox(120, 127, 40, 20, "Text4");
          userdialog.Text(170, 130, 25, 15, "mm");
          userdialog.Text(20, 160, 100, 15, "Direita");
          ...
          userdialog.Text(280, 100, 100, 14, "Largura");
          userdialog.TextBox(380, 97, 40, 21, "Text1");
          userdialog.Text(430, 100, 30, 14, "mm");
          userdialog.Text(280, 130, 100, 14, "Altura");
          userdialog.TextBox(380, 127, 40, 21, "Text3");
          userdialog.Text(430, 130, 30, 14, "mm");
          userdialog.GroupBox(280, 155, 220, 55, "Orientação");
          userdialog.OptionGroup("VAR_Orientation");
          userdialog.OptionButton(300, 170, 150, 15, "Retrato");
          userdialog.OptionButton(300, 190, 150, 15, "Paisagem");
          userdialog.OKButton();
          userdialog.CancelButton();
...
function GraphicDialogsFunc_Dlg3(dlgitem, action, suppvalue)
{
  ...
  switch(action) {
    case 1:
      g_tPaperFormat[0] = new tPaperFormatType("Definido pelo usuário", 0, 0);      // userdefined
      ...
      g_tPaperFormat[5] = new tPaperFormatType("Ofício", 216, 356);              // Legal
...
function extensionselect(sextension, bcheckuserdialog)
{
  ...
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 170, "Relatório");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "O relatório não pôde ser gerado utilizando o foramto selecionado de saída!");
  userdialog.Text(10, 25, 460, 15, "Selecione uma nova opção. Clique em OK para finalizar sua seleção.");
  userdialog.GroupBox(7, 50, 686, 85, "Opções de saída");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "Formato Rich Text (*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "Arquivo HTML (*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "Arquivo de texto (*.txt)");
  userdialog.OptionButton(20, 110, 580, 15, "Documento Word (*.doc)");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function changeexgraph(g_ooutfile, bcheckuserdialog)
{
  ...
  var sextension = ""; 
  var sfilestring = ""; 
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 152, "Relatório");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "Não foi possível gerar o relatório com gráfico utilizando as opções selecionadas de saída!");
  userdialog.Text(10, 25, 460, 15, "Selecione uma nova opção. Clique em OK para finalizar sua seleção.");
  userdialog.GroupBox(7, 50, 686, 67, "Opções de saída");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "Formato Rich Text (*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "Arquivo HTML (*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "Documento Word (*.doc)");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function outstatistic(omodels, srulenamelist, sobjstring, nstatistic, outputObject, nsemloc)
{
  ...
  while (nstart <= nmodelcount) {
    ...
    outputObject.TableCell((("Regra/" + sobjstring) + " Número"), nfirstcellwidth, "Arial", 12, 0, 8421504, 0, 137, 0);
    ...
    ssheetname = "Regras - Estatísticas";
    if ((nindex > 1)) {
  ...
  // tablehead
  outputObject.TableRow();
  outputObject.TableCell((sobjstring + " Número"), 10, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("Nome", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  ...
  outputObject.EndTable(("Estatísticas - " + sobjstring), 100, "Arial", 10, 0, - 1, 0, 136, 0);
}
...
function setReportHeaderFooterWithTitle(outfile, nloc, bDisplayServer, bDisplayDatabase, bDisplayUser, sTitle)  // BLUE-11195
{
    ...
    if(bDisplayDatabase)
        outfile.OutputLnF(("Banco de dados: " + ArisData.getActiveDatabase().Name(nloc)), "REPORT2");
    
    if(bDisplayUser)
        outfile.OutputLnF(("Usuário: " + ArisData.getActiveUser().Name(nloc)), "REPORT2");
