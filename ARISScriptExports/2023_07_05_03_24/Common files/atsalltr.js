...
function graphicdialogs(g_ooutfile, bcheckuserdialog)
{
  ...
  if (bcheckuserdialog.value) {
    ...
    while (binput == false) {
      var userdialog = Dialogs.createNewDialogTemplate(700, 310, "Biçim grafiği", "GraphicDialogsFunc_Dlg1");      
      // %GRID:10,7,1,1
      userdialog.Text(10, 10, 460, 15, "Model grafik nasıl görüntüle istiyorsunuz?");
      userdialog.Text(10, 25, 460, 15, "Seçiminizi sonlandırmak için TAMAM seçeneğine tıklayın.");
      userdialog.GroupBox(7, 50, 686, 55, "Renk");
      userdialog.OptionGroup("options1");
      userdialog.OptionButton(20, 65, 580, 15, "Renk");
      userdialog.OptionButton(20, 80, 580, 15, "Siyah ve beyaz");
      userdialog.GroupBox(7, 120, 686, 85, "Ölçekleme");
      userdialog.TextBox(200, 132, 60, 20, "Text0");
      userdialog.Text(280, 135, 50, 15, " %");
      userdialog.OptionGroup("options3");
      userdialog.OptionButton(20, 135, 180, 15, "Kullanıcı tanımlı");
      userdialog.OptionButton(20, 150, 80, 15, "%100");
      userdialog.OptionButton(20, 165, 580, 15, "Sayfaya sığdırmak için ölçekleme boyutu");
      userdialog.OptionButton(20, 182, 660, 15, "Yazdırma ölçeği modeli");
      userdialog.GroupBox(7, 220, 686, 55, "Kes");
      userdialog.OptionGroup("options4");
      userdialog.OptionButton(20, 235, 580, 15, "Nesneleri kenar boşluğunda kes");
      userdialog.OptionButton(20, 250, 580, 15, "Nesneleri kenar boşluğunun dışına kaydır");
      userdialog.OKButton();
        ...
        if ( !(isNaN(dlg.getDlgText("Text0"))) ) {
          ...
          if (nscalevalue.value >= 10 && nscalevalue.value <= 400) {    // BLUE-10197 Adapted to the allowed values in Designer 
            binput = true;
                        ...
                        Dialogs.MsgBox("Lütfen 10 ve 400 arasında bir değer girin.", 0, "Rapor");
          }

        }
        else {
                    Dialogs.MsgBox("Lütfen bir değer girin.", 0, "Rapor");
        }
    ...
    if (! (nuserdlg1 == 0)) {
      ...
      // (No page settings for HTML output)
        ...
        while (binput == false) {
          ...
          var userdialog = Dialogs.createNewDialogTemplate(520, 280, "Rapor", "GraphicDialogsFunc_Dlg3");       // %GRID:10,7,1,1
          userdialog.Text(10, 10, 460, 15, "Sayfa düzeni belirtin.");
          userdialog.Text(10, 25, 460, 15, "Seçiminizi sonlandırmak için TAMAM seçeneğine tıklayın.");
          userdialog.GroupBox(10, 49, 240, 180, "Kenar boşlukları");
          userdialog.Text(20, 70, 100, 15, "Üst");
          userdialog.TextBox(120, 67, 40, 20, "Text0");
          userdialog.Text(170, 70, 25, 15, "mm");
          userdialog.Text(20, 100, 100, 15, "Alt");
          userdialog.TextBox(120, 97, 40, 20, "Text2");
          userdialog.Text(170, 100, 25, 15, "mm");
          userdialog.Text(20, 130, 100, 15, "Sol");
          userdialog.TextBox(120, 127, 40, 20, "Text4");
          userdialog.Text(170, 130, 25, 15, "mm");
          userdialog.Text(20, 160, 100, 15, "Sağ");
          userdialog.TextBox(120, 157, 40, 20, "Text5");
          userdialog.Text(170, 160, 25, 15, "mm");
          userdialog.GroupBox(270, 49, 240, 180, "Kağıt biçimi");
          userdialog.DropListBox(280, 67, 220, 70, g_sPaperFormat, "VAR_PaperFormat");
          userdialog.Text(280, 100, 100, 14, "Genişlik");
          userdialog.TextBox(380, 97, 40, 21, "Text1");
          userdialog.Text(430, 100, 30, 14, "mm");
          userdialog.Text(280, 130, 100, 14, "Yükseklik");
          userdialog.TextBox(380, 127, 40, 21, "Text3");
          userdialog.Text(430, 130, 30, 14, "mm");
          userdialog.GroupBox(280, 155, 220, 55, "Yönlendirme");
          userdialog.OptionGroup("VAR_Orientation");
          userdialog.OptionButton(300, 170, 150, 15, "Dikey");
          userdialog.OptionButton(300, 190, 150, 15, "Yatay");
          userdialog.OKButton();
          userdialog.CancelButton();
...
function GraphicDialogsFunc_Dlg3(dlgitem, action, suppvalue)
{
  ...
  switch(action) {
    case 1:
      g_tPaperFormat[0] = new tPaperFormatType("Kullanıcı tanımlı", 0, 0);      // userdefined
      ...
      g_tPaperFormat[4] = new tPaperFormatType("Mektup", 216, 280);             // Letter
...
function extensionselect(sextension, bcheckuserdialog)
{
  ...
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 170, "Rapor");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "The selected output option cannot be used to create the report.");
  userdialog.Text(10, 25, 460, 15, "Lütfen başka bir seçenek seçin. Seçiminizi sonlandırmak için TAMAM seçeneğine tıklayın.");
  userdialog.GroupBox(7, 50, 686, 85, "Çıktı seçenekleri");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "Zengin Metin Biçimi (*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "HTML Dosyası (*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "Metin Dosyası (*.txt)");
  userdialog.OptionButton(20, 110, 580, 15, "Word Belgesi (*.doc)");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function changeexgraph(g_ooutfile, bcheckuserdialog)
{
  ...
  var sextension = ""; 
  var sfilestring = ""; 
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 152, "Rapor");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "The selected output option cannot be used to create the report with graphic.");
  userdialog.Text(10, 25, 460, 15, "Lütfen başka bir seçenek seçin. Seçiminizi sonlandırmak için TAMAM seçeneğine tıklayın.");
  userdialog.GroupBox(7, 50, 686, 67, "Çıktı seçenekleri");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "Zengin Metin Biçimi (*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "HTML Dosyası (*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "Word Belgesi (*.doc)");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function outstatistic(omodels, srulenamelist, sobjstring, nstatistic, outputObject, nsemloc)
{
  ...
  while (nstart <= nmodelcount) {
    ...
    outputObject.TableCell((("Kural/" + sobjstring) + " Hayır."), nfirstcellwidth, "Arial", 12, 0, 8421504, 0, 137, 0);
    ...
    ssheetname = "İstatistikleri - kurallar";
    if ((nindex > 1)) {
  ...
  // tablehead
  outputObject.TableRow();
  outputObject.TableCell((sobjstring + " Hayır."), 10, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("Ad", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("Tür", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("Grup", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  // tablebody
  ...
  outputObject.EndTable(("İstatistikler - " + sobjstring), 100, "Arial", 10, 0, - 1, 0, 136, 0);
}
...
function setReportHeaderFooterWithTitle(outfile, nloc, bDisplayServer, bDisplayDatabase, bDisplayUser, sTitle)  // BLUE-11195
{
    ...
    outfile.TableCell("", 26, "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_CENTER | Constants.FMT_VCENTER, 0);
    outfile.Output("Sayfa ", "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER, 0);
    ...
    if(bDisplayServer)
        outfile.OutputLnF(("Sunucu: " + ArisData.getActiveDatabase().ServerName()), "REPORT2");
    
    if(bDisplayDatabase)
        outfile.OutputLnF(("Veritabanı: " + ArisData.getActiveDatabase().Name(nloc)), "REPORT2");
    
    if(bDisplayUser)
        outfile.OutputLnF(("Kullanıcı: " + ArisData.getActiveUser().Name(nloc)), "REPORT2");
