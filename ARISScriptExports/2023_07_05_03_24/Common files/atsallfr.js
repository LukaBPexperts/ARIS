...
function graphicdialogs(g_ooutfile, bcheckuserdialog)
{
  ...
  if (bcheckuserdialog.value) {
    ...
    while (binput == false) {
      var userdialog = Dialogs.createNewDialogTemplate(700, 310, "Formater graphique", "GraphicDialogsFunc_Dlg1");      
      // %GRID:10,7,1,1
      userdialog.Text(10, 10, 460, 15, "Comment le graphique de modèle doit-il être représenté ?");
      userdialog.Text(10, 25, 460, 15, "Confirmez votre choix en cliquant sur 'OK'.");
      userdialog.GroupBox(7, 50, 686, 55, "Couleur");
      userdialog.OptionGroup("options1");
      userdialog.OptionButton(20, 65, 580, 15, "En couleur");
      userdialog.OptionButton(20, 80, 580, 15, "Noir et blanc");
      userdialog.GroupBox(7, 120, 686, 85, "Echelle");
      userdialog.TextBox(200, 132, 60, 20, "Text0");
      userdialog.Text(280, 135, 50, 15, " %");
      userdialog.OptionGroup("options3");
      userdialog.OptionButton(20, 135, 180, 15, "Personnalisé");
      userdialog.OptionButton(20, 150, 80, 15, "100%");
      userdialog.OptionButton(20, 165, 580, 15, "Ajuster à la taille de la page");
      userdialog.OptionButton(20, 182, 660, 15, "Echelle d'impression des modèles");
      userdialog.GroupBox(7, 220, 686, 55, "Couper");
      userdialog.OptionGroup("options4");
      userdialog.OptionButton(20, 235, 580, 15, "Couper marges des objets");
      userdialog.OptionButton(20, 250, 580, 15, "Chevaucher marges des objets");
      userdialog.OKButton();
        ...
        if ( !(isNaN(dlg.getDlgText("Text0"))) ) {
          ...
          if (nscalevalue.value >= 10 && nscalevalue.value <= 400) {    // BLUE-10197 Adapted to the allowed values in Designer 
            binput = true;
                        ...
                        Dialogs.MsgBox("Saisir les valeurs numériques < 400.", 0, "Rapport");
          }

        }
        else {
                    Dialogs.MsgBox("Saisir les valeurs numériques.", 0, "Rapport");
        }
    ...
    if (! (nuserdlg1 == 0)) {
      ...
      // (No page settings for HTML output)
        ...
        while (binput == false) {
          ...
          var userdialog = Dialogs.createNewDialogTemplate(520, 280, "Rapport", "GraphicDialogsFunc_Dlg3");       // %GRID:10,7,1,1
          userdialog.Text(10, 10, 460, 15, "Veuillez indiquer la mise en page.");
          userdialog.Text(10, 25, 460, 15, "Confirmez votre choix en cliquant sur OK.");
          userdialog.GroupBox(10, 49, 240, 180, "Marges");
          userdialog.Text(20, 70, 100, 15, "Haut");
          userdialog.TextBox(120, 67, 40, 20, "Text0");
          userdialog.Text(170, 70, 25, 15, "mm");
          userdialog.Text(20, 100, 100, 15, "Bas");
          userdialog.TextBox(120, 97, 40, 20, "Text2");
          userdialog.Text(170, 100, 25, 15, "mm");
          userdialog.Text(20, 130, 100, 15, "Gauche");
          userdialog.TextBox(120, 127, 40, 20, "Text4");
          userdialog.Text(170, 130, 25, 15, "mm");
          userdialog.Text(20, 160, 100, 15, "Droite");
          userdialog.TextBox(120, 157, 40, 20, "Text5");
          userdialog.Text(170, 160, 25, 15, "mm");
          userdialog.GroupBox(270, 49, 240, 180, "Format papier");
          userdialog.DropListBox(280, 67, 220, 70, g_sPaperFormat, "VAR_PaperFormat");
          userdialog.Text(280, 100, 100, 14, "Largeur");
          userdialog.TextBox(380, 97, 40, 21, "Text1");
          userdialog.Text(430, 100, 30, 14, "mm");
          userdialog.Text(280, 130, 100, 14, "Hauteur");
          userdialog.TextBox(380, 127, 40, 21, "Text3");
          userdialog.Text(430, 130, 30, 14, "mm");
          userdialog.GroupBox(280, 155, 220, 55, "Orientation");
          userdialog.OptionGroup("VAR_Orientation");
          userdialog.OptionButton(300, 170, 150, 15, "Portrait");
          userdialog.OptionButton(300, 190, 150, 15, "Paysage");
          userdialog.OKButton();
          userdialog.CancelButton();
...
function GraphicDialogsFunc_Dlg3(dlgitem, action, suppvalue)
{
  ...
  switch(action) {
    case 1:
      g_tPaperFormat[0] = new tPaperFormatType("Personnalisé", 0, 0);      // userdefined
      ...
      g_tPaperFormat[4] = new tPaperFormatType("Lettre", 216, 280);             // Letter
...
function extensionselect(sextension, bcheckuserdialog)
{
  ...
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 170, "Rapport");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "Le rapport ne pourra pas être créé avec l'option de sortie sélectionnée !");
  userdialog.Text(10, 25, 460, 15, "Veuillez sélectionner une autre option. Confirmez votre choix en cliquant sur OK.");
  userdialog.GroupBox(7, 50, 686, 85, "Options de sortie");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "Rich Text Format (*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "Fichier HTML (*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "Fichier texte (*.txt)");
  userdialog.OptionButton(20, 110, 580, 15, "Document Word (*.doc)");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function changeexgraph(g_ooutfile, bcheckuserdialog)
{
  ...
  var sextension = ""; 
  var sfilestring = ""; 
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 152, "Rapport");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "Le rapport avec graphique ne pourra pas être créé avec l'option de sortie sélectionnée !");
  userdialog.Text(10, 25, 460, 15, "Veuillez sélectionner une autre option. Confirmez votre choix en cliquant sur OK.");
  userdialog.GroupBox(7, 50, 686, 67, "Options de sortie");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "Rich Text Format (*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "Fichier HTML (*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "Document Word (*.doc)");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function outstatistic(omodels, srulenamelist, sobjstring, nstatistic, outputObject, nsemloc)
{
  ...
  while (nstart <= nmodelcount) {
    ...
    outputObject.TableCell((("Règle/" + sobjstring) + " N° :"), nfirstcellwidth, "Arial", 12, 0, 8421504, 0, 137, 0);
    ...
    ssheetname = "Statistiques - Règles";
    if ((nindex > 1)) {
  ...
  outputObject.TableCell("Nom", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("Type", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("Groupe", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  // tablebody
  ...
  outputObject.EndTable(("Statistique - " + sobjstring), 100, "Arial", 10, 0, - 1, 0, 136, 0);
}
...
function setReportHeaderFooterWithTitle(outfile, nloc, bDisplayServer, bDisplayDatabase, bDisplayUser, sTitle)  // BLUE-11195
{
    ...
    outfile.TableCell("", 26, "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_CENTER | Constants.FMT_VCENTER, 0);
    outfile.Output("Page ", "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER, 0);
    ...
    if(bDisplayServer)
        outfile.OutputLnF(("Serveur : " + ArisData.getActiveDatabase().ServerName()), "REPORT2");
    
    if(bDisplayDatabase)
        outfile.OutputLnF(("Base de données : " + ArisData.getActiveDatabase().Name(nloc)), "REPORT2");
    
    if(bDisplayUser)
        outfile.OutputLnF(("Utilisateur : " + ArisData.getActiveUser().Name(nloc)), "REPORT2");
