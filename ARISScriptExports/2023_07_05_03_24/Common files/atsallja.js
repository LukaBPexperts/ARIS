...
// our version of the Date object used for "時間" only, with overloaded toString():
__time = function()
{
  this.d = new Date();
}
...
function graphicdialogs(g_ooutfile, bcheckuserdialog)
{
  ...
  if (bcheckuserdialog.value) {
    ...
    while (binput == false) {
      var userdialog = Dialogs.createNewDialogTemplate(700, 310, "グラフィックの形式設定", "GraphicDialogsFunc_Dlg1");      
      // %GRID:10,7,1,1
      userdialog.Text(10, 10, 460, 15, "モデル グラフィックの表示方法を選択してください｡");
      userdialog.Text(10, 25, 460, 15, "[OK] をクリックして、選択項目を確定します。");
      userdialog.GroupBox(7, 50, 686, 55, "色");
      userdialog.OptionGroup("options1");
      userdialog.OptionButton(20, 65, 580, 15, "色");
      userdialog.OptionButton(20, 80, 580, 15, "白黒");
      userdialog.GroupBox(7, 120, 686, 85, "倍率");
      userdialog.TextBox(200, 132, 60, 20, "テキスト0");
      userdialog.Text(280, 135, 50, 15, " %");
      userdialog.OptionGroup("options3");
      userdialog.OptionButton(20, 135, 180, 15, "ユーザー定義");
      userdialog.OptionButton(20, 150, 80, 15, "100%");
      userdialog.OptionButton(20, 165, 580, 15, "ページの大きさに合わせる");
      userdialog.OptionButton(20, 182, 660, 15, "モデルの印刷倍率");
      userdialog.GroupBox(7, 220, 686, 55, "切り取り");
      userdialog.OptionGroup("options4");
      userdialog.OptionButton(20, 235, 580, 15, "余白でオブジェクトを切り捨て");
      userdialog.OptionButton(20, 250, 580, 15, "余白を超えるオブジェクトを重ね合わせる");
      userdialog.OKButton();
...
//      userdialog.HelpButton("HID_atsall_dlg_01.hlp");
      ...
      dlg.setDlgText("テキスト0", new String(nscalevalue.value));
      ...
      if (dlg.getDlgValue("options3") == 0) {
        if ( !(isNaN(dlg.getDlgText("テキスト0"))) ) {
          nscalevalue.value = parseInt(dlg.getDlgText("テキスト0"));
          if (nscalevalue.value >= 10 && nscalevalue.value <= 400) {    // BLUE-10197 Adapted to the allowed values in Designer 
            binput = true;
          }
          else {
                        Dialogs.MsgBox("0 ～ 400 の間で値を入力してください。", 0, "レポート");
          }

        }
        else {
                    Dialogs.MsgBox("数値を入力してください。", 0, "レポート");
        }
    ...
    if (! (nuserdlg1 == 0)) {
      ...
      // (No page settings for HTML output)
        ...
        while (binput == false) {
          ...
          var userdialog = Dialogs.createNewDialogTemplate(520, 280, "レポート", "GraphicDialogsFunc_Dlg3");       // %GRID:10,7,1,1
          userdialog.Text(10, 10, 460, 15, "ページ レイアウトを設定してください。");
          userdialog.Text(10, 25, 460, 15, "[OK] をクリックして、選択項目を確定します。");
          userdialog.GroupBox(10, 49, 240, 180, "余白");
          userdialog.Text(20, 70, 100, 15, "上");
          userdialog.TextBox(120, 67, 40, 20, "テキスト0");
          userdialog.Text(170, 70, 25, 15, "mm");
          userdialog.Text(20, 100, 100, 15, "下");
          userdialog.TextBox(120, 97, 40, 20, "テキスト2");
          userdialog.Text(170, 100, 25, 15, "mm");
          userdialog.Text(20, 130, 100, 15, "左");
          userdialog.TextBox(120, 127, 40, 20, "テキスト4");
          userdialog.Text(170, 130, 25, 15, "mm");
          userdialog.Text(20, 160, 100, 15, "右");
          userdialog.TextBox(120, 157, 40, 20, "テキスト5");
          userdialog.Text(170, 160, 25, 15, "mm");
          userdialog.GroupBox(270, 49, 240, 180, "用紙形式");
          userdialog.DropListBox(280, 67, 220, 70, g_sPaperFormat, "VAR_PaperFormat");
          userdialog.Text(280, 100, 100, 14, "幅");
          userdialog.TextBox(380, 97, 40, 21, "テキスト1");
          userdialog.Text(430, 100, 30, 14, "mm");
          userdialog.Text(280, 130, 100, 14, "高さ");
          userdialog.TextBox(380, 127, 40, 21, "テキスト3");
          userdialog.Text(430, 130, 30, 14, "mm");
          userdialog.GroupBox(280, 155, 220, 55, "方向");
          userdialog.OptionGroup("VAR_Orientation");
          userdialog.OptionButton(300, 170, 150, 15, "縦");
          userdialog.OptionButton(300, 190, 150, 15, "横");
          userdialog.OKButton();
          userdialog.CancelButton();
//          userdialog.HelpButton("HID_atsall_dlg_02.hlp");          

          var dlg3 = Dialogs.createUserDialog(userdialog); 
          dlg3.setDlgText("テキスト0", new String(ntop.value));
          dlg3.setDlgText("テキスト2", new String(nbottom.value));
          dlg3.setDlgText("テキスト4", new String(nleft.value));
          dlg3.setDlgText("テキスト5", new String(nright.value));
          dlg3.setDlgText("テキスト1", new String(nwidth.value));
          dlg3.setDlgText("テキスト3", new String(nheight.value));
          nuserdlg3 = Dialogs.show( __currentDialog = dlg3);
          // Showing dialog and waiting for confirmation with OK
          if ( isNaN(dlg3.getDlgText("テキスト0")) || isNaN(dlg3.getDlgText("テキスト1")) || isNaN(dlg3.getDlgText("テキスト2")) || isNaN(dlg3.getDlgText("テキスト3")) || isNaN(dlg3.getDlgText("テキスト4")) || isNaN(dlg3.getDlgText("テキスト5")) ) {
                        Dialogs.MsgBox("数値を入力してください。", 0, "レポート");
          }
          else {
            binput = true;
            ntop.value = parseInt(parseInt(dlg3.getDlgText("テキスト0")));
            nbottom.value = parseInt(parseInt(dlg3.getDlgText("テキスト2")));
            nleft.value = parseInt(parseInt(dlg3.getDlgText("テキスト4")));
            nright.value = parseInt(parseInt(dlg3.getDlgText("テキスト5")));
            nwidth.value = parseInt(parseInt(dlg3.getDlgText("テキスト1")));
            nheight.value = parseInt(parseInt(dlg3.getDlgText("テキスト3")));
          }
...
function GraphicDialogsFunc_Dlg3(dlgitem, action, suppvalue)
{
  ...
  switch(action) {
    case 1:
      g_tPaperFormat[0] = new tPaperFormatType("ユーザー定義", 0, 0);      // userdefined
      ...
      if (__currentDialog.getDlgText("テキスト1") <= __currentDialog.getDlgText("テキスト3")) {
      ...
      for (var i = 0 ; i < g_tPaperFormat.length ; i++ ) {
       if (((new java.lang.String(__currentDialog.getDlgText("テキスト1")).equals(new java.lang.String(g_tPaperFormat[i].nWidth))) && 
            (new java.lang.String(__currentDialog.getDlgText("テキスト3")).equals(new java.lang.String(g_tPaperFormat[i].nHeight)))) || 
           ((new java.lang.String(__currentDialog.getDlgText("テキスト3")).equals(new java.lang.String(g_tPaperFormat[i].nWidth))) &&
            (new java.lang.String(__currentDialog.getDlgText("テキスト1")).equals(new java.lang.String(g_tPaperFormat[i].nHeight))))) {
      ...
      if (! (bfound)) {
        ...
        if (__currentDialog.getDlgText("テキスト1") <= __currentDialog.getDlgText("テキスト3")) {
            g_tPaperFormat[0].nWidth =  __currentDialog.getDlgText("テキスト1");
            g_tPaperFormat[0].nHeight = __currentDialog.getDlgText("テキスト3");
        }
        else {
            g_tPaperFormat[0].nWidth =  __currentDialog.getDlgText("テキスト3");
            g_tPaperFormat[0].nHeight = __currentDialog.getDlgText("テキスト1");
        }
      }
      break;
    ...
    case 2:
      switch(dlgitem) {
        case "VAR_Orientation":
			if ((suppvalue == 0 && (__currentDialog.getDlgText("テキスト1") > __currentDialog.getDlgText("テキスト3"))) ||
                (suppvalue == 1 && (__currentDialog.getDlgText("テキスト1") < __currentDialog.getDlgText("テキスト3")))) {
        
                var sValue = __currentDialog.getDlgText("テキスト1");
                __currentDialog.setDlgText("テキスト1", __currentDialog.getDlgText("テキスト3"));
                __currentDialog.setDlgText("テキスト3", sValue);
            }
        break;
        case "VAR_PaperFormat":
          if (suppvalue >= 0 && suppvalue < g_tPaperFormat.length) {
            if (__currentDialog.getDlgValue("VAR_Orientation") == 0) {
                __currentDialog.setDlgText("テキスト1", new String(g_tPaperFormat[suppvalue].nWidth));
                __currentDialog.setDlgText("テキスト3", new String(g_tPaperFormat[suppvalue].nHeight));
            }
            else {
                __currentDialog.setDlgText("テキスト1", new String(g_tPaperFormat[suppvalue].nHeight));
                __currentDialog.setDlgText("テキスト3", new String(g_tPaperFormat[suppvalue].nWidth));
            }
          }
          break;
      }
...
/*      
    ...
    if (sdummy == "-1" || nscaleoption.value == 3) {
      ...
      ntop.value = parseInt(Context.getProfileString("SCRIPT_atsall", "上", new String(g_ooutfile.value.GetTopMargin())));
      nbottom.value = parseInt(Context.getProfileString("SCRIPT_atsall", "下", new String(g_ooutfile.value.GetBottomMargin())));
      nleft.value = parseInt(Context.getProfileString("SCRIPT_atsall", "左", new String(g_ooutfile.value.GetLeftMargin())));
      nright.value = parseInt(Context.getProfileString("SCRIPT_atsall", "右", new String(g_ooutfile.value.GetRightMargin())));
      nwidth.value = parseInt(Context.getProfileString("SCRIPT_atsall", "幅", new String(g_ooutfile.value.GetPageWidth())));
      nheight.value = parseInt(Context.getProfileString("SCRIPT_atsall", "高さ", new String(g_ooutfile.value.GetPageHeight())));
    }
*/
  }
...
// Anubis 301983 / Page settings no longer saved in 'user registry'
/*      
    Context.writeProfileString("SCRIPT_atsall", "上", new String(ntop));
    Context.writeProfileString("SCRIPT_atsall", "下", new String(nbottom));
    Context.writeProfileString("SCRIPT_atsall", "左", new String(nleft));
    Context.writeProfileString("SCRIPT_atsall", "右", new String(nright));
    Context.writeProfileString("SCRIPT_atsall", "幅", new String(nwidth));
    Context.writeProfileString("SCRIPT_atsall", "高さ", new String(nheight));
*/    
...
function extensionselect(sextension, bcheckuserdialog)
{
  ...
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 170, "レポート");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "選択した出力オプションは、レポートの作成には使用できません。");
  userdialog.Text(10, 25, 460, 15, "別のオプションを選択してください。[OK] をクリックして、選択項目を確定します。");
  userdialog.GroupBox(7, 50, 686, 85, "出力オプション");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "リッチ テキスト形式(*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "HTML ファイル(*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "テキスト ファイル(*.txt)");
  userdialog.OptionButton(20, 110, 580, 15, "Word 文書(*.doc)");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function changeexgraph(g_ooutfile, bcheckuserdialog)
{
  ...
  var sextension = ""; 
  var sfilestring = ""; 
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 152, "レポート");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "選択した出力オプションは、グラフィックのあるレポートの作成には使用できません。");
  userdialog.Text(10, 25, 460, 15, "別のオプションを選択してください。[OK] をクリックして、選択項目を確定します。");
  userdialog.GroupBox(7, 50, 686, 67, "出力オプション");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "リッチ テキスト形式(*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "HTML ファイル(*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "Word 文書(*.doc)");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function outstatistic(omodels, srulenamelist, sobjstring, nstatistic, outputObject, nsemloc)
{
  ...
  // rules/models
  outputObject.OutputLn("", "MS UI Gothic", 14, 0, - 1, 9, 0);
  outputObject.OutputField(5, "MS UI Gothic", 12, 0, - 1, 16);
  outputObject.OutputLn("", "MS UI Gothic", 14, 0, - 1, 9, 0);
  ...
  while (nstart <= nmodelcount) {
    ...
    outputObject.TableCell((("ルール/" + sobjstring) + " 番号"), nfirstcellwidth, "MS UI Gothic", 12, 0, 8421504, 0, 137, 0);
    for ( i = nstart ; i < nend+1 ; i++ ){
      outputObject.TableCell(new String(i + 1), ncellwidth, "MS UI Gothic", 12, 0, 8421504, 0, 145, 0);
    }
    ...
    for ( i = 0 ; i < srulenamelist.length ; i++ ){
      outputObject.TableRow();
      outputObject.TableCell( new String(i + 1) + ". " + srulenamelist[i], nfirstcellwidth, "MS UI Gothic", 12, 0, - 1, 0, 137, 0);
      ...
      for ( j = nstart ; j < nend+1 ; j++ ){
        ...
        outputObject.TableCell(soutstring, ncellwidth, "MS UI Gothic", 12, 0, - 1, 0, 144, 0);
      }
    ...
    outputObject.EndTable(ssheetname, 100, "MS UI Gothic", 10, 0, - 1, 0, 136, 0);
  ...
  // tablehead
  outputObject.TableRow();
  outputObject.TableCell((sobjstring + " 番号"), 10, "MS UI Gothic", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("名前", 30, "MS UI Gothic", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("タイプ", 30, "MS UI Gothic", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("グループ", 30, "MS UI Gothic", 12, 0, 8421504, 0, 137, 0);
  // tablebody
  for ( i = 0 ; i < (omodels.length - 1)+1 ; i++ ){
    ocurrentmodel = omodels[i];
    outputObject.TableRow();
    outputObject.TableCell(new String((i + 1)), 10, "MS UI Gothic", 12, 0, - 1, 0, 136, 0);
    outputObject.TableCell(ocurrentmodel.Name(nsemloc), 30, "MS UI Gothic", 12, 0, - 1, 0, 136, 0);
    outputObject.TableCell(ocurrentmodel.Type(), 30, "MS UI Gothic", 12, 0, - 1, 0, 136, 0);
    outputObject.TableCell(ocurrentmodel.Group().Path(nsemloc), 30, "MS UI Gothic", 12, 0, - 1, 0, 136, 0);
    ocurrentmodel = null;
  }

  outputObject.EndTable(("統計 :" + sobjstring), 100, "MS UI Gothic", 10, 0, - 1, 0, 136, 0);
}
...
function setReportHeaderFooterWithTitle(outfile, nloc, bDisplayServer, bDisplayDatabase, bDisplayUser, sTitle)  // BLUE-11195
{
    ...
    outfile.TableRow();
    outfile.TableCell("", 26, "MS UI Gothic", 12, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_CENTER | Constants.FMT_VCENTER, 0);
    outfile.OutGraphic(pictleft, - 1, 40, 15);
    outfile.TableCell(sTitle, 48, "MS UI Gothic", 12, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_CENTER | Constants.FMT_VCENTER, 0);
    outfile.TableCell("", 26, "MS UI Gothic", 12, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_CENTER | Constants.FMT_VCENTER, 0);
    outfile.OutGraphic(pictright, - 1, 40, 15);
    outfile.EndTable("", 100, "MS UI Gothic", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
    outfile.EndHeader();
    ...
    outfile.BeginTable(100, borderColor, Constants.C_TRANSPARENT, Constants.FMT_LEFT, 0);
    outfile.TableRow();
    outfile.TableCell("", 26, "MS UI Gothic", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_CENTER | Constants.FMT_VCENTER, 0);
    outfile.OutputField(Constants.FIELD_DATE, "MS UI Gothic", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER);
    outfile.Output(" ", "MS UI Gothic", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER, 0);
    outfile.OutputField(Constants.FIELD_TIME, "MS UI Gothic", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER);
    outfile.TableCell(Context.getSelectedFile(), 48, "MS UI Gothic", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_CENTER | Constants.FMT_VCENTER, 0);
    outfile.TableCell("", 26, "MS UI Gothic", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_CENTER | Constants.FMT_VCENTER, 0);
    outfile.Output("ページ", "MS UI Gothic", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER, 0);
    outfile.OutputField(Constants.FIELD_PAGE, "MS UI Gothic", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER);
    outfile.Output(" /", "MS UI Gothic", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER, 0);
    outfile.OutputField(Constants.FIELD_NUMPAGES, "MS UI Gothic", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER);
    outfile.EndTable("", 100, "MS UI Gothic", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
    outfile.EndFooter();
    ...
    if(bDisplayServer)
        outfile.OutputLnF(("サーバー: " + ArisData.getActiveDatabase().ServerName()), "REPORT2"); 
    
    if(bDisplayDatabase)
        outfile.OutputLnF(("データベース:" + ArisData.getActiveDatabase().Name(nloc)), "REPORT2");
    
    if(bDisplayUser)
        outfile.OutputLnF(("ユーザー:" + ArisData.getActiveUser().Name(nloc)), "REPORT2");
...
function writeTableHeaderWithColor(outfile, colHeadings, fontSize, backColor, textColor)
{
    ...
    for(var i = 0; i < colHeadings.length; i++) {
        ...
        outfile.TableCell(colHeadings[i], colWidth, "MS UI Gothic", fontSize, textColor, backColor, 0, Constants.FMT_BOLD | Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
...
function writeTableHeaderWithColorWidths(outfile, colHeadings, fontSize, backColor, textColor, colWidths)
{
  ...
  for(var i=0;i<colHeadings.length;i++)
    outfile.TableCell(colHeadings[i], colWidths[i], "MS UI Gothic", fontSize, textColor, backColor, 0, Constants.FMT_BOLD | Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
}
...
function writeTableHeaderVertWithColor(outfile, colHeadings, fontSize, firstVertColIdx, backColor, textColor)
{
    ...
    for(var i = 0; i < colHeadings.length; i++) {
        ...
        outfile.TableCell(colHeadings[i], colWidth, "MS UI Gothic", fontSize, textColor, backColor, 0, nFlags, 0);
        colSum = colSum + colWidth;
    }
}
...
function writeTableHeaderWidths(outfile, colHeadings, colWidths, fontSize)
{
  ...
  for(var i=0;i<colHeadings.length;i++)
    outfile.TableCell(colHeadings[i], colWidths[i], "MS UI Gothic", fontSize, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_BOLD | Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
}
