...
function graphicdialogs(g_ooutfile, bcheckuserdialog)
{
  ...
  if (bcheckuserdialog.value) {
    ...
    while (binput == false) {
      var userdialog = Dialogs.createNewDialogTemplate(700, 310, "Dar formato al gráfico", "GraphicDialogsFunc_Dlg1");      
      // %GRID:10,7,1,1
      userdialog.Text(10, 10, 460, 15, "¿Cómo desea representar el gráfico de modelo?");
      userdialog.Text(10, 25, 460, 15, "Finalice su selección haciendo clic en 'Aceptar'.");
      userdialog.GroupBox(7, 50, 686, 55, "Color");
      userdialog.OptionGroup("options1");
      userdialog.OptionButton(20, 65, 580, 15, "En color");
      userdialog.OptionButton(20, 80, 580, 15, "En blanco y negro");
      userdialog.GroupBox(7, 120, 686, 85, "Escala");
      userdialog.TextBox(200, 132, 60, 20, "Text0");
      userdialog.Text(280, 135, 50, 15, " %");
      userdialog.OptionGroup("options3");
      userdialog.OptionButton(20, 135, 180, 15, "Definido por el usuario");
      userdialog.OptionButton(20, 150, 80, 15, "100%");
      userdialog.OptionButton(20, 165, 580, 15, "Ajustar al tamaño de página");
      userdialog.OptionButton(20, 182, 660, 15, "Escala de impresión de los modelos");
      userdialog.GroupBox(7, 220, 686, 55, "Cortar");
      userdialog.OptionGroup("options4");
      userdialog.OptionButton(20, 235, 580, 15, "Cortar los objetos por el margen");
      userdialog.OptionButton(20, 250, 580, 15, "Organizar los objetos en cascada");
      userdialog.OKButton();
        ...
        if ( !(isNaN(dlg.getDlgText("Text0"))) ) {
          ...
          if (nscalevalue.value >= 10 && nscalevalue.value <= 400) {    // BLUE-10197 Adapted to the allowed values in Designer 
            binput = true;
                        ...
                        Dialogs.MsgBox("Introducir números < 400.", 0, "Informe");
          }

        }
        else {
                    Dialogs.MsgBox("Introducir números.", 0, "Informe");
        }
    ...
    if (! (nuserdlg1 == 0)) {
      ...
      // (No page settings for HTML output)
        ...
        while (binput == false) {
          ...
          var userdialog = Dialogs.createNewDialogTemplate(520, 280, "Informe", "GraphicDialogsFunc_Dlg3");       // %GRID:10,7,1,1
          userdialog.Text(10, 10, 460, 15, "Indique el diseño de página.");
          userdialog.Text(10, 25, 460, 15, "Finalice su selección con Aceptar.");
          userdialog.GroupBox(10, 49, 240, 180, "Márgenes");
          userdialog.Text(20, 70, 100, 15, "Arriba");
          userdialog.TextBox(120, 67, 40, 20, "Text0");
          userdialog.Text(170, 70, 25, 15, "mm");
          userdialog.Text(20, 100, 100, 15, "Abajo");
          userdialog.TextBox(120, 97, 40, 20, "Text2");
          userdialog.Text(170, 100, 25, 15, "mm");
          userdialog.Text(20, 130, 100, 15, "Izquierdo");
          userdialog.TextBox(120, 127, 40, 20, "Text4");
          userdialog.Text(170, 130, 25, 15, "mm");
          userdialog.Text(20, 160, 100, 15, "Derecho");
          userdialog.TextBox(120, 157, 40, 20, "Text5");
          userdialog.Text(170, 160, 25, 15, "mm");
          userdialog.GroupBox(270, 49, 240, 180, "Formato de papel");
          userdialog.DropListBox(280, 67, 220, 70, g_sPaperFormat, "VAR_PaperFormat");
          userdialog.Text(280, 100, 100, 14, "Ancho");
          userdialog.TextBox(380, 97, 40, 21, "Text1");
          userdialog.Text(430, 100, 30, 14, "mm");
          userdialog.Text(280, 130, 100, 14, "Alto");
          userdialog.TextBox(380, 127, 40, 21, "Text3");
          userdialog.Text(430, 130, 30, 14, "mm");
          userdialog.GroupBox(280, 155, 220, 55, "Alineación");
          userdialog.OptionGroup("VAR_Orientation");
          userdialog.OptionButton(300, 170, 150, 15, "Orientación vertical");
          userdialog.OptionButton(300, 190, 150, 15, "Orientación horizontal");
          userdialog.OKButton();
          userdialog.CancelButton();
...
function GraphicDialogsFunc_Dlg3(dlgitem, action, suppvalue)
{
  ...
  switch(action) {
    case 1:
      g_tPaperFormat[0] = new tPaperFormatType("Definido por el usuario", 0, 0);      // userdefined
      ...
      g_tPaperFormat[4] = new tPaperFormatType("Carta", 216, 280);             // Letter
      g_tPaperFormat[5] = new tPaperFormatType("Oficio", 216, 356);              // Legal
...
function extensionselect(sextension, bcheckuserdialog)
{
  ...
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 170, "Informe");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "¡Con la opción de salida seleccionada no es posible elaborar el informe!");
  userdialog.Text(10, 25, 460, 15, "Seleccione otra opción. Finalice su selección con Aceptar.");
  userdialog.GroupBox(7, 50, 686, 85, "Opciones de salida");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "Rich Text Format (*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "Archivo HTML (*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "Archivo de texto (*.txt)");
  userdialog.OptionButton(20, 110, 580, 15, "Documento de Word (*.doc)");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function changeexgraph(g_ooutfile, bcheckuserdialog)
{
  ...
  var sextension = ""; 
  var sfilestring = ""; 
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 152, "Informe");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "¡Con la opción de salida seleccionada no se puede elaborar el informe con gráfico!");
  userdialog.Text(10, 25, 460, 15, "Seleccione otra opción. Finalice su selección con Aceptar.");
  userdialog.GroupBox(7, 50, 686, 67, "Opciones de salida");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "Rich Text Format (*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "Archivo HTML (*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "Documento de Word (*.doc)");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function outstatistic(omodels, srulenamelist, sobjstring, nstatistic, outputObject, nsemloc)
{
  ...
  while (nstart <= nmodelcount) {
    ...
    outputObject.TableCell((("Regla/" + sobjstring) + " N°."), nfirstcellwidth, "Arial", 12, 0, 8421504, 0, 137, 0);
  ...
  // tablehead
  outputObject.TableRow();
  outputObject.TableCell((sobjstring + " N°."), 10, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("Nombre", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("Tipo", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("Grupo", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  // tablebody
  ...
  outputObject.EndTable(("Estadística - " + sobjstring), 100, "Arial", 10, 0, - 1, 0, 136, 0);
}
...
function setReportHeaderFooterWithTitle(outfile, nloc, bDisplayServer, bDisplayDatabase, bDisplayUser, sTitle)  // BLUE-11195
{
    ...
    outfile.TableCell("", 26, "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_CENTER | Constants.FMT_VCENTER, 0);
    outfile.Output("Página ", "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER, 0);
    outfile.OutputField(Constants.FIELD_PAGE, "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER);
    outfile.Output(" de ", "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER, 0);
    ...
    if(bDisplayServer)
        outfile.OutputLnF(("Servidor: " + ArisData.getActiveDatabase().ServerName()), "REPORT2");
    
    if(bDisplayDatabase)
        outfile.OutputLnF(("Base de datos: " + ArisData.getActiveDatabase().Name(nloc)), "REPORT2");
    
    if(bDisplayUser)
        outfile.OutputLnF(("Usuario: " + ArisData.getActiveUser().Name(nloc)), "REPORT2");
