...
function initStyles(p_oOut, p_sFont) {
    ...
    p_oOut.DefineF("TBL_HEAD", p_sFont, FONT_SIZE*.8, COL_TBL_HEAD_TXT, Constants.C_TRANSPARENT, Constants.FMT_LEFT | Constants.FMT_VBOTTOM, 0, 0, 0, 1, 0, 1.1); // Table head
