...
function graphicdialogs(g_ooutfile, bcheckuserdialog)
{
  ...
  if (bcheckuserdialog.value) {
    ...
    while (binput == false) {
      var userdialog = Dialogs.createNewDialogTemplate(700, 310, "Formatuj grafikę", "GraphicDialogsFunc_Dlg1");      
      // %GRID:10,7,1,1
      userdialog.Text(10, 10, 460, 15, "Użyć następujących opcji żeby wyświetlić grafikę modelu.");
      userdialog.Text(10, 25, 460, 15, "Kliknij przycisk OK, aby potwierdzić wybór.");
      userdialog.GroupBox(7, 50, 686, 55, "Kolor");
      userdialog.OptionGroup("options1");
      userdialog.OptionButton(20, 65, 580, 15, "Kolorowy");
      userdialog.OptionButton(20, 80, 580, 15, "Czarno-biały");
      userdialog.GroupBox(7, 120, 686, 85, "Skalowanie");
      userdialog.TextBox(200, 132, 60, 20, "Text0");
      userdialog.Text(280, 135, 50, 15, " %");
      userdialog.OptionGroup("options3");
      userdialog.OptionButton(20, 135, 180, 15, "Zdefiniowany przez użytkownika");
      userdialog.OptionButton(20, 150, 80, 15, "100%");
      userdialog.OptionButton(20, 165, 580, 15, "Skaluj, żeby dopasować rozmiar strony");
      userdialog.OptionButton(20, 182, 660, 15, "Skalowanie wydruku modelu");
      userdialog.GroupBox(7, 220, 686, 55, "Wytnij");
      userdialog.OptionGroup("options4");
      userdialog.OptionButton(20, 235, 580, 15, "Wytnij obiekty przy marginesie");
      userdialog.OptionButton(20, 250, 580, 15, "Rozmieść obiekty poza marginesem");
      userdialog.OKButton();
        ...
        if ( !(isNaN(dlg.getDlgText("Text0"))) ) {
          ...
          if (nscalevalue.value >= 10 && nscalevalue.value <= 400) {    // BLUE-10197 Adapted to the allowed values in Designer 
            binput = true;
                        ...
                        Dialogs.MsgBox("Wprowadź wartości numeryczne pomiędzy 10 a 400.", 0, "Raport");
          }

        }
        else {
                    Dialogs.MsgBox("Wprowadź wartości numeryczne.", 0, "Raport");
        }
    ...
    if (! (nuserdlg1 == 0)) {
      ...
      // (No page settings for HTML output)
        ...
        while (binput == false) {
          ...
          var userdialog = Dialogs.createNewDialogTemplate(520, 280, "Raport", "GraphicDialogsFunc_Dlg3");       // %GRID:10,7,1,1
          userdialog.Text(10, 10, 460, 15, "Wybrać układ strony.");
          userdialog.Text(10, 25, 460, 15, "Kliknij przycisk OK, aby potwierdzić wybór.");
          userdialog.GroupBox(10, 49, 240, 180, "Marginesy");
          userdialog.Text(20, 70, 100, 15, "Do góry");
          userdialog.TextBox(120, 67, 40, 20, "Text0");
          userdialog.Text(170, 70, 25, 15, "mm");
          userdialog.Text(20, 100, 100, 15, "Do dołu");
          userdialog.TextBox(120, 97, 40, 20, "Text2");
          userdialog.Text(170, 100, 25, 15, "mm");
          userdialog.Text(20, 130, 100, 15, "Do lewej");
          userdialog.TextBox(120, 127, 40, 20, "Text4");
          userdialog.Text(170, 130, 25, 15, "mm");
          userdialog.Text(20, 160, 100, 15, "Do prawej");
          userdialog.TextBox(120, 157, 40, 20, "Text5");
          userdialog.Text(170, 160, 25, 15, "mm");
          userdialog.GroupBox(270, 49, 240, 180, "Rozmiar strony");
          userdialog.DropListBox(280, 67, 220, 70, g_sPaperFormat, "VAR_PaperFormat");
          userdialog.Text(280, 100, 100, 14, "Szerokość");
          userdialog.TextBox(380, 97, 40, 21, "Text1");
          userdialog.Text(430, 100, 30, 14, "mm");
          userdialog.Text(280, 130, 100, 14, "Wysokość");
          userdialog.TextBox(380, 127, 40, 21, "Text3");
          userdialog.Text(430, 130, 30, 14, "mm");
          userdialog.GroupBox(280, 155, 220, 55, "Orientacja");
          userdialog.OptionGroup("VAR_Orientation");
          userdialog.OptionButton(300, 170, 150, 15, "Pionowa");
          userdialog.OptionButton(300, 190, 150, 15, "Pozioma");
          userdialog.OKButton();
          userdialog.CancelButton();
...
function GraphicDialogsFunc_Dlg3(dlgitem, action, suppvalue)
{
  ...
  switch(action) {
    case 1:
      g_tPaperFormat[0] = new tPaperFormatType("Zdefiniowany przez użytkownika", 0, 0);      // userdefined
...
function extensionselect(sextension, bcheckuserdialog)
{
  ...
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 170, "Raport");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "Raport nie może być utworzony przy użyciu opcji wybranej opcji.");
  userdialog.Text(10, 25, 460, 15, "Wybrać nową opcję. Kliknij przycisk OK, aby potwierdzić wybór.");
  userdialog.GroupBox(7, 50, 686, 85, "Opcje wyjściowe");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "Tekst sformatowany RTF (*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "Plik HTML (*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "Plik tekstowy (*.txt)");
  userdialog.OptionButton(20, 110, 580, 15, "Dokument programu Word (*.doc)");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function changeexgraph(g_ooutfile, bcheckuserdialog)
{
  ...
  var sextension = ""; 
  var sfilestring = ""; 
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 152, "Raport");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "Nie można utworzyć raportu z grafiką używając wybranej opcji.");
  userdialog.Text(10, 25, 460, 15, "Wybrać nową opcję. Kliknij przycisk OK, aby potwierdzić wybór.");
  userdialog.GroupBox(7, 50, 686, 67, "Opcje wyjściowe");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "Tekst sformatowany RTF (*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "Plik HTML (*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "Dokument programu Word (*.doc)");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function outstatistic(omodels, srulenamelist, sobjstring, nstatistic, outputObject, nsemloc)
{
  ...
  while (nstart <= nmodelcount) {
    ...
    outputObject.TableCell((("Reguła/" + sobjstring) + " Numer"), nfirstcellwidth, "Arial", 12, 0, 8421504, 0, 137, 0);
  ...
  // tablehead
  outputObject.TableRow();
  outputObject.TableCell((sobjstring + " Numer"), 10, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("Nazwa", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("Typ", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("Grupa", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  // tablebody
  ...
  outputObject.EndTable(("Statystyki - " + sobjstring), 100, "Arial", 10, 0, - 1, 0, 136, 0);
}
...
function setReportHeaderFooterWithTitle(outfile, nloc, bDisplayServer, bDisplayDatabase, bDisplayUser, sTitle)  // BLUE-11195
{
    ...
    outfile.TableCell("", 26, "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_CENTER | Constants.FMT_VCENTER, 0);
    outfile.Output("Strona ", "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER, 0);
    outfile.OutputField(Constants.FIELD_PAGE, "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER);
    outfile.Output(" z ", "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER, 0);
    ...
    if(bDisplayServer)
        outfile.OutputLnF(("Serwer: " + ArisData.getActiveDatabase().ServerName()), "REPORT2");
    
    if(bDisplayDatabase)
        outfile.OutputLnF(("Baza danych: " + ArisData.getActiveDatabase().Name(nloc)), "REPORT2");
    
    if(bDisplayUser)
        outfile.OutputLnF(("Użytkownik: " + ArisData.getActiveUser().Name(nloc)), "REPORT2");
