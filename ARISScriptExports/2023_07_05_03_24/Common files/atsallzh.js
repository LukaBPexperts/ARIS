...
function graphicdialogs(g_ooutfile, bcheckuserdialog)
{
  ...
  if (bcheckuserdialog.value) {
    ...
    while (binput == false) {
      var userdialog = Dialogs.createNewDialogTemplate(700, 310, "格式图形", "GraphicDialogsFunc_Dlg1");      
      // %GRID:10,7,1,1
      userdialog.Text(10, 10, 460, 15, "您婓朷柾宆渻样旐显帵丠");
      userdialog.Text(10, 25, 460, 15, "单击“确定”以结束您的选择。");
      userdialog.GroupBox(7, 50, 686, 55, "颜色");
      userdialog.OptionGroup("options1");
      userdialog.OptionButton(20, 65, 580, 15, "颜色");
      userdialog.OptionButton(20, 80, 580, 15, "黑白");
      userdialog.GroupBox(7, 120, 686, 85, "缩放比例");
      userdialog.TextBox(200, 132, 60, 20, "Text0");
      userdialog.Text(280, 135, 50, 15, " %");
      userdialog.OptionGroup("options3");
      userdialog.OptionButton(20, 135, 180, 15, "用户定义");
      userdialog.OptionButton(20, 150, 80, 15, "100%");
      userdialog.OptionButton(20, 165, 580, 15, "缩放以适合页面大小");
      userdialog.OptionButton(20, 182, 660, 15, "模型打印比例");
      userdialog.GroupBox(7, 220, 686, 55, "剪切");
      userdialog.OptionGroup("options4");
      userdialog.OptionButton(20, 235, 580, 15, "剪切位于边缘的对象");
      userdialog.OptionButton(20, 250, 580, 15, "覆盖超过页边距的对象");
      userdialog.OKButton();
        ...
        if ( !(isNaN(dlg.getDlgText("Text0"))) ) {
          ...
          if (nscalevalue.value >= 10 && nscalevalue.value <= 400) {    // BLUE-10197 Adapted to the allowed values in Designer 
            binput = true;
                        ...
                        Dialogs.MsgBox("请输入一个介于 10 到 400 之间的数字。", 0, "报表");
          }

        }
        else {
                    Dialogs.MsgBox("请为警告限制输入一个大于。", 0, "报表");
        }
    ...
    if (! (nuserdlg1 == 0)) {
      ...
      // (No page settings for HTML output)
        ...
        while (binput == false) {
          ...
          var userdialog = Dialogs.createNewDialogTemplate(520, 280, "报表", "GraphicDialogsFunc_Dlg3");       // %GRID:10,7,1,1
          userdialog.Text(10, 10, 460, 15, "请指定页面布局。");
          userdialog.Text(10, 25, 460, 15, "单击“确定”以结束您的选择。");
          userdialog.GroupBox(10, 49, 240, 180, "页边距");
          userdialog.Text(20, 70, 100, 15, "顶");
          userdialog.TextBox(120, 67, 40, 20, "Text0");
          userdialog.Text(170, 70, 25, 15, "毫米");
          userdialog.Text(20, 100, 100, 15, "底");
          userdialog.TextBox(120, 97, 40, 20, "Text2");
          userdialog.Text(170, 100, 25, 15, "毫米");
          userdialog.Text(20, 130, 100, 15, "左");
          userdialog.TextBox(120, 127, 40, 20, "Text4");
          userdialog.Text(170, 130, 25, 15, "毫米");
          userdialog.Text(20, 160, 100, 15, "右");
          userdialog.TextBox(120, 157, 40, 20, "Text5");
          userdialog.Text(170, 160, 25, 15, "毫米");
          userdialog.GroupBox(270, 49, 240, 180, "纸张格式");
          userdialog.DropListBox(280, 67, 220, 70, g_sPaperFormat, "VAR_PaperFormat");
          userdialog.Text(280, 100, 100, 14, "宽度");
          userdialog.TextBox(380, 97, 40, 21, "Text1");
          userdialog.Text(430, 100, 30, 14, "毫米");
          userdialog.Text(280, 130, 100, 14, "高度");
          userdialog.TextBox(380, 127, 40, 21, "Text3");
          userdialog.Text(430, 130, 30, 14, "毫米");
          userdialog.GroupBox(280, 155, 220, 55, "方向");
          userdialog.OptionGroup("VAR_Orientation");
          userdialog.OptionButton(300, 170, 150, 15, "纵向");
          userdialog.OptionButton(300, 190, 150, 15, "横向");
          userdialog.OKButton();
          userdialog.CancelButton();
...
function GraphicDialogsFunc_Dlg3(dlgitem, action, suppvalue)
{
  ...
  switch(action) {
    case 1:
      g_tPaperFormat[0] = new tPaperFormatType("用户定义", 0, 0);      // userdefined
      ...
      g_tPaperFormat[4] = new tPaperFormatType("字符", 216, 280);             // Letter
      g_tPaperFormat[5] = new tPaperFormatType("规奿", 216, 356);              // Legal
...
function extensionselect(sextension, bcheckuserdialog)
{
  ...
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 170, "报表");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "无法使用选定的输出选项创建报表。");
  userdialog.Text(10, 25, 460, 15, "选择选项。 单击“确定”以结束您的选择。");
  userdialog.GroupBox(7, 50, 686, 85, "输出选项");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "RTF 格式（*.rtf）");
  userdialog.OptionButton(20, 80, 580, 15, "HTML 文件（*.htm）");
  userdialog.OptionButton(20, 95, 580, 15, "文本文件（*.txt）");
  userdialog.OptionButton(20, 110, 580, 15, "Word 文档（*.doc）");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function changeexgraph(g_ooutfile, bcheckuserdialog)
{
  ...
  var sextension = ""; 
  var sfilestring = ""; 
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 152, "报表");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "无法使用选定的输出选项创建包含图形的报表。");
  userdialog.Text(10, 25, 460, 15, "选择选项。 单击“确定”以结束您的选择。");
  userdialog.GroupBox(7, 50, 686, 67, "输出选项");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "RTF 格式（*.rtf）");
  userdialog.OptionButton(20, 80, 580, 15, "HTML 文件（*.htm）");
  userdialog.OptionButton(20, 95, 580, 15, "Word 文档（*.doc）");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function outstatistic(omodels, srulenamelist, sobjstring, nstatistic, outputObject, nsemloc)
{
  ...
  // rules/models
  outputObject.OutputLn("", "宋体", 14, 0, - 1, 9, 0);
  outputObject.OutputField(5, "宋体", 12, 0, - 1, 16);
  outputObject.OutputLn("", "宋体", 14, 0, - 1, 9, 0);
  ...
  while (nstart <= nmodelcount) {
    ...
    outputObject.TableCell((("规则/" + sobjstring) + " 号"), nfirstcellwidth, "宋体", 12, 0, 8421504, 0, 137, 0);
    for ( i = nstart ; i < nend+1 ; i++ ){
      outputObject.TableCell(new String(i + 1), ncellwidth, "宋体", 12, 0, 8421504, 0, 145, 0);
    }
    ...
    for ( i = 0 ; i < srulenamelist.length ; i++ ){
      outputObject.TableRow();
      outputObject.TableCell( new String(i + 1) + ". " + srulenamelist[i], nfirstcellwidth, "宋体", 12, 0, - 1, 0, 137, 0);
      ...
      for ( j = nstart ; j < nend+1 ; j++ ){
        ...
        outputObject.TableCell(soutstring, ncellwidth, "宋体", 12, 0, - 1, 0, 144, 0);
      }
    ...
    outputObject.EndTable(ssheetname, 100, "宋体", 10, 0, - 1, 0, 136, 0);
  ...
  // tablehead
  outputObject.TableRow();
  outputObject.TableCell((sobjstring + " 号"), 10, "宋体", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("名称", 30, "宋体", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("类型", 30, "宋体", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("组", 30, "宋体", 12, 0, 8421504, 0, 137, 0);
  // tablebody
  for ( i = 0 ; i < (omodels.length - 1)+1 ; i++ ){
    ocurrentmodel = omodels[i];
    outputObject.TableRow();
    outputObject.TableCell(new String((i + 1)), 10, "宋体", 12, 0, - 1, 0, 136, 0);
    outputObject.TableCell(ocurrentmodel.Name(nsemloc), 30, "宋体", 12, 0, - 1, 0, 136, 0);
    outputObject.TableCell(ocurrentmodel.Type(), 30, "宋体", 12, 0, - 1, 0, 136, 0);
    outputObject.TableCell(ocurrentmodel.Group().Path(nsemloc), 30, "宋体", 12, 0, - 1, 0, 136, 0);
    ocurrentmodel = null;
  }

  outputObject.EndTable(("统计 - " + sobjstring), 100, "宋体", 10, 0, - 1, 0, 136, 0);
}
...
function setReportHeaderFooterWithTitle(outfile, nloc, bDisplayServer, bDisplayDatabase, bDisplayUser, sTitle)  // BLUE-11195
{
    ...
    outfile.TableRow();
    outfile.TableCell("", 26, "宋体", 12, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_CENTER | Constants.FMT_VCENTER, 0);
    outfile.OutGraphic(pictleft, - 1, 40, 15);
    outfile.TableCell(sTitle, 48, "宋体", 12, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_CENTER | Constants.FMT_VCENTER, 0);
    outfile.TableCell("", 26, "宋体", 12, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_CENTER | Constants.FMT_VCENTER, 0);
    outfile.OutGraphic(pictright, - 1, 40, 15);
    outfile.EndTable("", 100, "宋体", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
    outfile.EndHeader();
    ...
    outfile.BeginTable(100, borderColor, Constants.C_TRANSPARENT, Constants.FMT_LEFT, 0);
    outfile.TableRow();
    outfile.TableCell("", 26, "宋体", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_CENTER | Constants.FMT_VCENTER, 0);
    outfile.OutputField(Constants.FIELD_DATE, "宋体", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER);
    outfile.Output(" ", "宋体", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER, 0);
    outfile.OutputField(Constants.FIELD_TIME, "宋体", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER);
    outfile.TableCell(Context.getSelectedFile(), 48, "宋体", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_CENTER | Constants.FMT_VCENTER, 0);
    outfile.TableCell("", 26, "宋体", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_CENTER | Constants.FMT_VCENTER, 0);
    outfile.Output("第 ", "宋体", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER, 0);
    outfile.OutputField(Constants.FIELD_PAGE, "宋体", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER);
    outfile.Output(" / ", "宋体", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER, 0);
    outfile.OutputField(Constants.FIELD_NUMPAGES, "宋体", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER);
    outfile.EndTable("", 100, "宋体", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
    outfile.EndFooter();
    ...
    if(bDisplayServer)
        outfile.OutputLnF(("服务器： " + ArisData.getActiveDatabase().ServerName()), "REPORT2");
    
    if(bDisplayDatabase)
        outfile.OutputLnF(("数据库： " + ArisData.getActiveDatabase().Name(nloc)), "REPORT2");
    
    if(bDisplayUser)
        outfile.OutputLnF(("用户： " + ArisData.getActiveUser().Name(nloc)), "REPORT2");
...
function writeTableHeaderWithColor(outfile, colHeadings, fontSize, backColor, textColor)
{
    ...
    for(var i = 0; i < colHeadings.length; i++) {
        ...
        outfile.TableCell(colHeadings[i], colWidth, "宋体", fontSize, textColor, backColor, 0, Constants.FMT_BOLD | Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
...
function writeTableHeaderWithColorWidths(outfile, colHeadings, fontSize, backColor, textColor, colWidths)
{
  ...
  for(var i=0;i<colHeadings.length;i++)
    outfile.TableCell(colHeadings[i], colWidths[i], "宋体", fontSize, textColor, backColor, 0, Constants.FMT_BOLD | Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
}
...
function writeTableHeaderVertWithColor(outfile, colHeadings, fontSize, firstVertColIdx, backColor, textColor)
{
    ...
    for(var i = 0; i < colHeadings.length; i++) {
        ...
        outfile.TableCell(colHeadings[i], colWidth, "宋体", fontSize, textColor, backColor, 0, nFlags, 0);
        colSum = colSum + colWidth;
    }
}
...
function writeTableHeaderWidths(outfile, colHeadings, colWidths, fontSize)
{
  ...
  for(var i=0;i<colHeadings.length;i++)
    outfile.TableCell(colHeadings[i], colWidths[i], "宋体", fontSize, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_BOLD | Constants.FMT_LEFT | Constants.FMT_VTOP, 0);
}
