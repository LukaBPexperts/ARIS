...
function graphicdialogs(g_ooutfile, bcheckuserdialog)
{
  ...
  if (bcheckuserdialog.value) {
    ...
    while (binput == false) {
      var userdialog = Dialogs.createNewDialogTemplate(700, 310, "형식 그래픽", "GraphicDialogsFunc_Dlg1");      
      // %GRID:10,7,1,1
      userdialog.Text(10, 10, 460, 15, "How do you want to display the model graphic?");
      userdialog.Text(10, 25, 460, 15, "선택을 종료하려면 확인을 클릭하십시오.");
      userdialog.GroupBox(7, 50, 686, 55, "색");
      userdialog.OptionGroup("options1");
      userdialog.OptionButton(20, 65, 580, 15, "색");
      userdialog.OptionButton(20, 80, 580, 15, "흑백");
      userdialog.GroupBox(7, 120, 686, 85, "크기 조정");
      userdialog.TextBox(200, 132, 60, 20, "Text0");
      userdialog.Text(280, 135, 50, 15, " %");
      userdialog.OptionGroup("options3");
      userdialog.OptionButton(20, 135, 180, 15, "사용자 정의");
      userdialog.OptionButton(20, 150, 80, 15, "100%");
      userdialog.OptionButton(20, 165, 580, 15, "페이지 크기에 맞게 조정");
      userdialog.OptionButton(20, 182, 660, 15, "모델 축소/확대 배율");
      userdialog.GroupBox(7, 220, 686, 55, "자르기");
      userdialog.OptionGroup("options4");
      userdialog.OptionButton(20, 235, 580, 15, "여백에서 개체 자르기");
      userdialog.OptionButton(20, 250, 580, 15, "여백을 넘어가는 오버레이 개체");
      userdialog.OKButton();
        ...
        if ( !(isNaN(dlg.getDlgText("Text0"))) ) {
          ...
          if (nscalevalue.value >= 10 && nscalevalue.value <= 400) {    // BLUE-10197 Adapted to the allowed values in Designer 
            binput = true;
                        ...
                        Dialogs.MsgBox("Please enter a numerical value between 10 and 400.", 0, "보고서");
          }

        }
        else {
                    Dialogs.MsgBox("값 입력.", 0, "보고서");
        }
    ...
    if (! (nuserdlg1 == 0)) {
      ...
      // (No page settings for HTML output)
        ...
        while (binput == false) {
          ...
          var userdialog = Dialogs.createNewDialogTemplate(520, 280, "보고서", "GraphicDialogsFunc_Dlg3");       // %GRID:10,7,1,1
          userdialog.Text(10, 10, 460, 15, "페이지 레이아웃");
          userdialog.Text(10, 25, 460, 15, "선택을 종료하려면 확인을 클릭하십시오.");
          userdialog.GroupBox(10, 49, 240, 180, "여백");
          userdialog.Text(20, 70, 100, 15, "위");
          userdialog.TextBox(120, 67, 40, 20, "Text0");
          userdialog.Text(170, 70, 25, 15, "mm");
          userdialog.Text(20, 100, 100, 15, "아래");
          userdialog.TextBox(120, 97, 40, 20, "Text2");
          userdialog.Text(170, 100, 25, 15, "mm");
          userdialog.Text(20, 130, 100, 15, "왼쪽");
          userdialog.TextBox(120, 127, 40, 20, "Text4");
          userdialog.Text(170, 130, 25, 15, "mm");
          userdialog.Text(20, 160, 100, 15, "오른쪽");
          userdialog.TextBox(120, 157, 40, 20, "Text5");
          userdialog.Text(170, 160, 25, 15, "mm");
          userdialog.GroupBox(270, 49, 240, 180, "용지 종류");
          userdialog.DropListBox(280, 67, 220, 70, g_sPaperFormat, "VAR_PaperFormat");
          userdialog.Text(280, 100, 100, 14, "너비");
          userdialog.TextBox(380, 97, 40, 21, "Text1");
          userdialog.Text(430, 100, 30, 14, "mm");
          userdialog.Text(280, 130, 100, 14, "높이");
          userdialog.TextBox(380, 127, 40, 21, "Text3");
          userdialog.Text(430, 130, 30, 14, "mm");
          userdialog.GroupBox(280, 155, 220, 55, "방향");
          userdialog.OptionGroup("VAR_Orientation");
          userdialog.OptionButton(300, 170, 150, 15, "세로");
          userdialog.OptionButton(300, 190, 150, 15, "가로");
          userdialog.OKButton();
          userdialog.CancelButton();
...
function GraphicDialogsFunc_Dlg3(dlgitem, action, suppvalue)
{
  ...
  switch(action) {
    case 1:
      g_tPaperFormat[0] = new tPaperFormatType("사용자 정의", 0, 0);      // userdefined
      ...
      g_tPaperFormat[4] = new tPaperFormatType("레터", 216, 280);             // Letter
      g_tPaperFormat[5] = new tPaperFormatType("리걸", 216, 356);              // Legal
...
function extensionselect(sextension, bcheckuserdialog)
{
  ...
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 170, "보고서");
  // %GRID:10,7,1,1
  ...
  userdialog.GroupBox(7, 50, 686, 85, "출력 옵션");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "서식 있는 텍스트(*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "HTML 파일(*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "텍스트 파일(*.txt)");
  userdialog.OptionButton(20, 110, 580, 15, "Word 문서(*.doc)");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function changeexgraph(g_ooutfile, bcheckuserdialog)
{
  ...
  var sextension = ""; 
  var sfilestring = ""; 
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 152, "보고서");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "The selected output option cannot be used to create the report with graphic.");
  userdialog.Text(10, 25, 460, 15, "Please select another option. Click on OK to end your selection.");
  userdialog.GroupBox(7, 50, 686, 67, "출력 옵션");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "서식 있는 텍스트(*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "HTML 파일(*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "Word 문서(*.doc)");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function outstatistic(omodels, srulenamelist, sobjstring, nstatistic, outputObject, nsemloc)
{
  ...
  while (nstart <= nmodelcount) {
    ...
    outputObject.TableCell((("규칙/" + sobjstring) + " 번호"), nfirstcellwidth, "Arial", 12, 0, 8421504, 0, 137, 0);
  ...
  // tablehead
  outputObject.TableRow();
  outputObject.TableCell((sobjstring + " 번호"), 10, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("이름", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("유형", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("그룹", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  // tablebody
  ...
  outputObject.EndTable(("통계 - " + sobjstring), 100, "Arial", 10, 0, - 1, 0, 136, 0);
}
...
function setReportHeaderFooterWithTitle(outfile, nloc, bDisplayServer, bDisplayDatabase, bDisplayUser, sTitle)  // BLUE-11195
{
    ...
    outfile.TableCell("", 26, "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_CENTER | Constants.FMT_VCENTER, 0);
    outfile.Output("페이지 ", "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER, 0);
    ...
    if(bDisplayServer)
        outfile.OutputLnF(("서버: " + ArisData.getActiveDatabase().ServerName()), "REPORT2");
    
    if(bDisplayDatabase)
        outfile.OutputLnF(("데이터베이스: " + ArisData.getActiveDatabase().Name(nloc)), "REPORT2");
    
    if(bDisplayUser)
        outfile.OutputLnF(("사용자: " + ArisData.getActiveUser().Name(nloc)), "REPORT2");
