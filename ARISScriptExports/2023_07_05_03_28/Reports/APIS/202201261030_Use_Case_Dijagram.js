...
function main(startObjDefs) {
    ...
    oOutput.TableCell("", 10, getString("ID_DEFAULT_FONT"), 11, Constants.C_BLACK, RGB(217, 217, 217), 0, Constants.FMT_CENTER, 0)
    ...
    var uvodDokumenta = startModels[0].Attribute(ArisData.ActiveFilter().UserDefinedAttributeTypeNum("6e7a0971-479a-11ec-4a03-10604b88abdc"), nLocale).getValue()
    //oOutput.BeginParagraphF(getString("HEADING_1"))
    oOutput.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
    oOutput.Output(uvodDokumenta, getString("ID_STYLE_RD_DEFAULT"), 11, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_LEFT, 0)
    oOutput.EndParagraph()
    ...
    oOutput.Output("1.1 Opseg", getString("ID_STYLE_RD_DEFAULT"), 13, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_BOLD | Constants.FMT_LEFT, 0)
    oOutput.EndParagraph()

    var opsegDokumenta = startModels[0].Attribute(ArisData.ActiveFilter().UserDefinedAttributeTypeNum("8380ba31-479a-11ec-4a03-10604b88abdc"), nLocale).getValue()
    //oOutput.BeginParagraphF(getString("HEADING_1"))
    oOutput.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
    oOutput.Output(opsegDokumenta, getString("ID_STYLE_RD_DEFAULT"), 11, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_LEFT, 0)
    oOutput.EndParagraph()
    ...
    oOutput.BeginParagraphF(getString("HEADING_2"))
    oOutput.Output("1.2 Rječnik skraćenica i pojmova", getString("ID_STYLE_RD_DEFAULT"), 13, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_BOLD | Constants.FMT_LEFT, 0)
    oOutput.EndParagraph()

    //oOutput.BeginParagraphF(getString("HEADING_1"))
    oOutput.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
    oOutput.Output("Rječnik pojmova i skraćenica projekta nalazi se u dokumentu F109 Rječnik pojmova.", getString("ID_STYLE_RD_DEFAULT"), 11, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_LEFT, 0)
    oOutput.EndParagraph()
    ...
    //Preduvjeti
    oOutput.BeginParagraphF(getString("HEADING_2"))
    oOutput.Output("1.3 Preduvjeti", getString("ID_STYLE_RD_DEFAULT"), 13, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_BOLD | Constants.FMT_LEFT, 0)
    oOutput.EndParagraph()
    ...
    //Napomene
    oOutput.BeginParagraphF(getString("HEADING_2"))
    oOutput.Output("1.4 Napomene", getString("ID_STYLE_RD_DEFAULT"), 13, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_BOLD | Constants.FMT_LEFT, 0)
    oOutput.EndParagraph()
    ...
    oOutput.BeginParagraphF(getString("HEADING_1"))
    oOutput.Output("2. Opis sustava", getString("ID_STYLE_RD_DEFAULT"), 13, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_BOLD | Constants.FMT_LEFT, 0)
    oOutput.EndParagraph()

    var roleObjDefs = startModels[0].ObjDefListByTypes([Constants.OT_PERS_TYPE])

    emptyrow(1)

    //2.1 Popis i opis aktera
    oOutput.BeginParagraphF(getString("HEADING_2"))
    oOutput.Output("2.1 Popis i opis aktera", getString("ID_STYLE_RD_DEFAULT"), 13, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_BOLD | Constants.FMT_LEFT, 0)
    oOutput.EndParagraph()

    for (var i = 0; i < roleObjDefs.length; i++) {
        oOutput.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
        oOutput.Output(roleObjDefs[i].Name(nLocale), getString("ID_STYLE_RD_DEFAULT"), 11, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_BOLD | Constants.FMT_LEFT, 0)
        oOutput.EndParagraph()

        var longDescriptionAtt = roleObjDefs[i].Attribute(Constants.AT_DESC, nLocale).getValue()
        oOutput.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
    ...
    //2.1 Popis i opis aktera
    oOutput.BeginParagraphF(getString("HEADING_2"))
    oOutput.Output("2.2 Popis i opis UC", getString("ID_STYLE_RD_DEFAULT"), 13, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_BOLD | Constants.FMT_LEFT, 0)
    oOutput.EndParagraph()

    emptyrow(1)

    var useCaseObjDefs = startModels[0].ObjDefListByTypes([Constants.OT_FUNC])

    oOutput.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
    oOutput.Output("Popis UC-ova po funkcionalnim cjelinama:", getString("ID_STYLE_RD_DEFAULT"), 11, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_LEFT, 0)
    oOutput.EndParagraph()

    oOutput.BeginTable(100, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_LEFT | Constants.FMT_REPEAT_HEADER, 0)
    oOutput.TableRow()
    oOutput.ResetFrameStyle()
    oOutput.TableCell("Funkcionalne cjeline", 30, getString("ID_DEFAULT_FONT"), 11, Constants.C_BLACK, RGB(217, 217, 217), 0, Constants.FMT_CENTER | Constants.FMT_BOLD, 0)
    oOutput.TableCell("Popis UC-ova", 70, getString("ID_DEFAULT_FONT"), 11, Constants.C_BLACK, RGB(217, 217, 217), 0, Constants.FMT_CENTER | Constants.FMT_BOLD, 0)

    for (var i = 0; i < useCaseObjDefs.length; i++) {
        var funkcionalnaCjelina = useCaseObjDefs[i].Attribute(ArisData.ActiveFilter().UserDefinedAttributeTypeNum("ec777871-6249-11ec-4a03-10604b88abdc"), nLocale).getValue()
        oOutput.TableRow()
        oOutput.ResetFrameStyle()
        oOutput.TableCell(funkcionalnaCjelina, 30, getString("ID_DEFAULT_FONT"), 11, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_LEFT, 0)
        oOutput.TableCell(useCaseObjDefs[i].Name(nLocale), 70, getString("ID_DEFAULT_FONT"), 11, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_LEFT, 0)
    }
    oOutput.EndTable("", 100, "Segoe UI", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0)
    ...
    for (var i = 0; i < useCaseObjDefs.length; i++) {
        var opisUC = useCaseObjDefs[i].Attribute(ArisData.ActiveFilter().UserDefinedAttributeTypeNum("9c45d280-479a-11ec-4a03-10604b88abdc"), nLocale).getValue()

        oOutput.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
        oOutput.Output(useCaseObjDefs[i].Name(nLocale), getString("ID_STYLE_RD_DEFAULT"), 11, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_LEFT | Constants.FMT_BOLD, 0)
        oOutput.EndParagraph()
    ...
    oOutput.BeginParagraphF(getString("HEADING_2"))
    oOutput.Output("2.3 UC Dijagram", getString("ID_STYLE_RD_DEFAULT"), 13, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_BOLD | Constants.FMT_LEFT, 0)
    oOutput.EndParagraph()
    ...
    oOutput.BeginParagraphF(getString("HEADING_2"))
    oOutput.Output("2.4 Interakcija s postojećim procesima i aplikacijama", getString("ID_STYLE_RD_DEFAULT"), 13, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_BOLD | Constants.FMT_LEFT, 0)
    oOutput.EndParagraph()

    oOutput.BeginParagraphF(getString("ID_STYLE_RD_DEFAULT"))
    oOutput.Output("Na razini MVP-a predviđene su integracije sa sljedećim sustavima:", getString("ID_STYLE_RD_DEFAULT"), 11, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_LEFT, 0)
    oOutput.EndParagraph()

    emptyrow(1)

    oOutput.BeginParagraphF(getString("HEADING_2"))
    oOutput.Output("2.5 Prioriteti UC-a", getString("ID_STYLE_RD_DEFAULT"), 13, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_BOLD | Constants.FMT_LEFT, 0)
    oOutput.EndParagraph()

    oOutput.BeginTable(100, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_LEFT | Constants.FMT_REPEAT_HEADER, 0)
    oOutput.TableRow()
    oOutput.ResetFrameStyle()
    oOutput.TableCell("UC", 30, getString("ID_DEFAULT_FONT"), 11, Constants.C_BLACK, RGB(217, 217, 217), 0, Constants.FMT_CENTER | Constants.FMT_BOLD, 0)
    oOutput.TableCell("Prioritet", 70, getString("ID_DEFAULT_FONT"), 11, Constants.C_BLACK, RGB(217, 217, 217), 0, Constants.FMT_CENTER | Constants.FMT_BOLD, 0)

    for (var i = 0; i < useCaseObjDefs.length; i++) {
        var prioritetUC = useCaseObjDefs[i].Attribute(ArisData.ActiveFilter().UserDefinedAttributeTypeNum("8b830271-4799-11ec-4a03-10604b88abdc"), nLocale).getValue()
        oOutput.TableRow()
        oOutput.ResetFrameStyle()
        oOutput.TableCell(useCaseObjDefs[i].Name(nLocale), 30, getString("ID_DEFAULT_FONT"), 11, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_LEFT, 0)
        oOutput.TableCell(prioritetUC, 70, getString("ID_DEFAULT_FONT"), 11, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_CENTER, 0)
    }
    oOutput.EndTable("", 100, "Segoe UI", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_LEFT | Constants.FMT_VTOP, 0)
...
function firstPage() {
    ...
    oOutput.OutputLn("UC MODEL", getString("ID_DEFAULT_FONT"), 21, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_BOLD | Constants.FMT_CENTER, 0)
    oOutput.EndParagraph()
