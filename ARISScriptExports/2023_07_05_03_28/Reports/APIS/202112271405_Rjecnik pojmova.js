...
function globalHeader(outputObj) {
    ...
    outputObj.TableCell("", 30, getString("ID_DEFAULT_FONT"), 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_VTOP | Constants.FMT_LEFT, 0)
...
function main(startModels) {
    ...
    oOutput.EndParagraph()
    oOutput.TableCell("", 25, getString("ID_DEFAULT_FONT"), 11, Constants.C_BLACK, RGB(217, 217, 217), 0, Constants.FMT_CENTER, 0)
    oOutput.BeginParagraph(Constants.FMT_CENTER, 0.71, 0.71, 0, 0, 0)
    ...
    oOutput.EndParagraph()
    oOutput.TableCell("", 30, getString("ID_DEFAULT_FONT"), 11, Constants.C_BLACK, RGB(217, 217, 217), 0, Constants.FMT_CENTER, 0)
    oOutput.BeginParagraph(Constants.FMT_CENTER, 0.71, 0.71, 0, 0, 0)
    ...
    oOutput.TableRow()
    oOutput.ResetFrameStyle()
    oOutput.TableCell("", 11, getString("ID_DEFAULT_FONT"), 10, Constants.C_BLACK, RGB(217, 217, 217), 0, Constants.FMT_CENTER, 0)
    oOutput.BeginParagraph(Constants.FMT_CENTER, 0.71, 0.71, 0, 0, 0)
    oOutput.OutputLn("Verzija", getString("ID_DEFAULT_FONT"), 11, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_BOLD | Constants.FMT_CENTER, 0.71)
    oOutput.EndParagraph()
    ...
    oOutput.Output("    1.1. Pravni okvir / Referentni dokumenti", getString("ID_STYLE_RD_DEFAULT"), 13, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_BOLD | Constants.FMT_LEFT, 0)
    oOutput.EndParagraph()
    ...
    oOutput.OutputLn("Dokument", getString("ID_DEFAULT_FONT"), 11, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_LEFT | Constants.FMT_BOLD, 0.71)
    oOutput.EndParagraph()
    oOutput.TableCell("", 20, getString("ID_DEFAULT_FONT"), 10, Constants.C_BLACK, RGB(217, 217, 217), 0, Constants.FMT_CENTER, 0)
    oOutput.BeginParagraph(Constants.FMT_CENTER, 0.71, 0.71, 0, 0, 0)
    oOutput.OutputLn("Datum", getString("ID_DEFAULT_FONT"), 11, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_CENTER | Constants.FMT_BOLD, 0.71)
    oOutput.EndParagraph()

    for (var i = 0; i < 11; i++) {
        oOutput.TableRow()
        oOutput.ResetFrameStyle()
        oOutput.TableCell("", 80, getString("ID_DEFAULT_FONT"), 11, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_LEFT | Constants.FMT_CENTER, 0)
    ...
    oOutput.BeginParagraphF(getString("HEADING_1"))
    oOutput.Output("2. Rječnik skraćenica", getString("ID_STYLE_RD_DEFAULT"), 13, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_BOLD | Constants.FMT_LEFT, 0)
    oOutput.EndParagraph()
    ...
    oOutput.BeginParagraph(Constants.FMT_LEFT, 0.71, 0.71, 0, 0, 0)
    oOutput.OutputLn("Skraćenica", getString("ID_DEFAULT_FONT"), 11, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_LEFT | Constants.FMT_BOLD, 0.71)
    oOutput.EndParagraph()
    oOutput.TableCell("", 80, getString("ID_DEFAULT_FONT"), 10, Constants.C_BLACK, RGB(217, 217, 217), 0, Constants.FMT_CENTER, 0)
    oOutput.BeginParagraph(Constants.FMT_CENTER, 0.71, 0.71, 0, 0, 0)
    oOutput.OutputLn("Objašnjenje", getString("ID_DEFAULT_FONT"), 11, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_CENTER | Constants.FMT_BOLD, 0.71)
    oOutput.EndParagraph()
    ...
    for (var i = 0; i < skracenice.length; i++) {
        ...
        oOutput.TableRow()
        oOutput.ResetFrameStyle()
        oOutput.TableCell(skracenice[i].Name(nLocale), 20, getString("ID_DEFAULT_FONT"), 11, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_LEFT | Constants.FMT_CENTER, 0)
        oOutput.TableCell(skraceniceDescription, 80, getString("ID_DEFAULT_FONT"), 11, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_LEFT | Constants.FMT_CENTER, 0)
    ...
    oOutput.BeginParagraphF(getString("HEADING_1"))
    oOutput.Output("3. Rječnik pojmova", getString("ID_STYLE_RD_DEFAULT"), 13, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_BOLD | Constants.FMT_LEFT, 0)
    oOutput.EndParagraph()
    ...
    oOutput.BeginParagraphF(getString("HEADING_2"))
    oOutput.Output("    3.1. Popis pojmova", getString("ID_STYLE_RD_DEFAULT"), 13, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_BOLD | Constants.FMT_LEFT, 0)
    oOutput.EndParagraph()
    ...
    oOutput.TableCell("", 20, getString("ID_DEFAULT_FONT"), 10, Constants.C_BLACK, RGB(217, 217, 217), 0, Constants.FMT_LEFT, 0)
    oOutput.BeginParagraph(Constants.FMT_LEFT, 0.71, 0.71, 0, 0, 0)
    oOutput.OutputLn("Pojam", getString("ID_DEFAULT_FONT"), 11, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_LEFT | Constants.FMT_BOLD, 0.71)
    oOutput.EndParagraph()
    oOutput.TableCell("", 80, getString("ID_DEFAULT_FONT"), 10, Constants.C_BLACK, RGB(217, 217, 217), 0, Constants.FMT_CENTER, 0)
    oOutput.BeginParagraph(Constants.FMT_CENTER, 0.71, 0.71, 0, 0, 0)
    oOutput.OutputLn("Objašnjenje", getString("ID_DEFAULT_FONT"), 11, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_CENTER | Constants.FMT_BOLD, 0.71)
    ...
    for (var i = 0; i < pojmovi.length; i++) {
        ...
        oOutput.TableRow()
        oOutput.ResetFrameStyle()
        oOutput.TableCell(pojmovi[i].Name(nLocale), 20, getString("ID_DEFAULT_FONT"), 11, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_LEFT | Constants.FMT_CENTER, 0)
        oOutput.TableCell("", 80, getString("ID_DEFAULT_FONT"), 11, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_LEFT | Constants.FMT_CENTER, 0)
    ...
    oOutput.BeginParagraphF(getString("HEADING_2"))
    oOutput.Output("    3.1. Objašnjenje pojmova", getString("ID_STYLE_RD_DEFAULT"), 13, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_BOLD | Constants.FMT_LEFT, 0)
    oOutput.EndParagraph()
    ...
    oOutput.BeginParagraphF(getString("HEADING_1"))
    oOutput.Output("4. Napomene", getString("ID_STYLE_RD_DEFAULT"), 13, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_BOLD | Constants.FMT_LEFT, 0)
    oOutput.EndParagraph()
    ...
    oOutput.BeginParagraphF(getString("HEADING_1"))
    oOutput.Output("5. Otvorena pitanja", getString("ID_STYLE_RD_DEFAULT"), 13, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_BOLD | Constants.FMT_LEFT, 0)
    oOutput.EndParagraph()
    ...
    oOutput.BeginParagraphF(getString("HEADING_1"))
    oOutput.Output("6. Indeks pojmova", getString("ID_STYLE_RD_DEFAULT"), 13, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_BOLD | Constants.FMT_LEFT, 0)
    oOutput.EndParagraph()
...
function firstPage() {
    ...
    oOutput.OutputLn("Rječnik pojmova", getString("ID_DEFAULT_FONT"), 21, RGB(0, 0, 0), Constants.C_TRANSPARENT, Constants.FMT_BOLD | Constants.FMT_CENTER, 0)
    oOutput.EndParagraph()
