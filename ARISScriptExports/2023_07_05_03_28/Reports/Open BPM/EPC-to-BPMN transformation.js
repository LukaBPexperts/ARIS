 ...
 * It is recommended to create a copy of this report before performing any modifications.
 */
...
function optionsDialog() {
    this.getPages = function() {
        var MoveOptionsDialog = Dialogs.createNewDialogTemplate(500, 300, getString("DIALOG_HEADER"), "ProcessMoveOptionsDlgEvents");
