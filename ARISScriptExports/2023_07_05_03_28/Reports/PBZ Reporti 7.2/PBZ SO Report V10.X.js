...
{   
    ...
    if(g_currentVACD != null)
    {
     ...
     //g_objSheet.cell(g_rowCount, 12).setCellValue(g_currentVACD.Attribute(133845, nLocale).GetValue(false));  //187ad700-ba5e-11df-453f-005056b228c7 
     g_objSheet.cell(g_rowCount, 12).setCellValue(g_currentVACD.Attribute(ArisData.ActiveFilter().UserDefinedAttributeTypeNum("187ad700-ba5e-11df-453f-005056b228c7"), nLocale).getValue()); //custom 202202151115
     
     //g_objSheet.cell(g_rowCount, 13).setCellValue(g_currentVACD.Attribute(264917, nLocale).GetValue(false)); //da7d9350-ba5a-11df-453f-005056b228c7
     g_objSheet.cell(g_rowCount, 13).setCellValue(g_currentVACD.Attribute(ArisData.ActiveFilter().UserDefinedAttributeTypeNum("da7d9350-ba5a-11df-453f-005056b228c7"), nLocale).getValue()); //da7d9350-ba5a-11df-453f-005056b228c7 //custom 202202151115
     
     //g_objSheet.cell(g_rowCount, 14).setCellValue(g_currentVACD.Attribute(68314, nLocale).GetValue(false)); //82c22e20-ba53-11df-453f-005056b228c7
     g_objSheet.cell(g_rowCount, 14).setCellValue(g_currentVACD.Attribute(ArisData.ActiveFilter().UserDefinedAttributeTypeNum("82c22e20-ba53-11df-453f-005056b228c7"), nLocale).getValue()); //82c22e20-ba53-11df-453f-005056b228c7 //custom 202202151115
      
     //g_objSheet.cell(g_rowCount, 15).setCellValue(g_currentVACD.Attribute(527061, nLocale).GetValue(false)); //df74b510-ba72-11df-453f-005056b228c7
     g_objSheet.cell(g_rowCount, 15).setCellValue(g_currentVACD.Attribute(ArisData.ActiveFilter().UserDefinedAttributeTypeNum("df74b510-ba72-11df-453f-005056b228c7"), nLocale).getValue()); //df74b510-ba72-11df-453f-005056b228c7 //custom 202202151115
     
     //g_objSheet.cell(g_rowCount, 16).setCellValue(g_currentVACD.Attribute(264919, nLocale).GetValue(false)); //7cc66bd0-ba76-11df-453f-005056b228c7
     g_objSheet.cell(g_rowCount, 16).setCellValue(g_currentVACD.Attribute(ArisData.ActiveFilter().UserDefinedAttributeTypeNum("7cc66bd0-ba76-11df-453f-005056b228c7"), nLocale).getValue()); //7cc66bd0-ba76-11df-453f-005056b228c7 //custom 202202151115
    ...
    //g_objSheet.cell(g_rowCount, 20).setCellValue(getVACDFunction(g_currentEPC).Attribute(989, nLocale).GetValue(false)); //317ba885-7df8-11da-0c60-cf8e338f9a0b
    g_objSheet.cell(g_rowCount, 20).setCellValue(getVACDFunction(g_currentEPC).Attribute(ArisData.ActiveFilter().UserDefinedAttributeTypeNum("317ba885-7df8-11da-0c60-cf8e338f9a0b"), nLocale).getValue()); //317ba885-7df8-11da-0c60-cf8e338f9a0b //custom 202202151115
...
function writeFunctionForGroup(objFunction, objGroup, oPosition, oApplication)
{
    ...
    if(g_currentVACD != null)
    {
     ...
     g_objSheet.cell(g_rowCount, 11).setCellValue(g_currentVACD.GUID().toString());
    //g_objSheet.cell(g_rowCount, 12).setCellValue(g_currentVACD.Attribute(133845, nLocale).GetValue(false));  //187ad700-ba5e-11df-453f-005056b228c7
     g_objSheet.cell(g_rowCount, 12).setCellValue(g_currentVACD.Attribute(ArisData.ActiveFilter().UserDefinedAttributeTypeNum("187ad700-ba5e-11df-453f-005056b228c7"), nLocale).getValue());
    ...
    g_objSheet.cell(g_rowCount, 18).setCellValue(g_currentEPC.Name(nLocale));
    g_objSheet.cell(g_rowCount, 19).setCellValue(g_currentEPC.GUID().toString());
    g_objSheet.cell(g_rowCount, 20).setCellValue(getVACDFunction(g_currentEPC).Attribute(989, nLocale).getValue());
