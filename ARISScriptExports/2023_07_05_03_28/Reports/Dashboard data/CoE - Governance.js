...
var CHANGE_REQUEST_WORKFLOW_GUID = m_valueAccess.getParameterValue("ChangeRequest");
var APPROVE_WORKFLOW_GUID        = m_valueAccess.getParameterValue("Approval");
var SHARE_WORKFLOW_GUID          = m_valueAccess.getParameterValue("Share");
...
function main() {
    ...
    var ChangeRequest_instances = PROCESS.getInstances();    
    ...
    var Approve_instances = PROCESS.getInstances();    
    ...
    var Share_instances = PROCESS.getInstances();    
