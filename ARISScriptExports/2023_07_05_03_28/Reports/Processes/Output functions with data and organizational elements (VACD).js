          ...
          for (var r = 0; r < oobjoccs.length; r++) {
            ...
            if (ocxnoccs.length > 0) {
              ...
              for (var h = 0; h < ocxnoccs.length; h++) {
                ...
                if (getcxnocc2orgelem(ocurrentobjocc, ocurrentcxnocc, scxnname, oconobjdef, nOptOrgElements) == true) {
...
function getcxnocc2orgelem(ocurrentobjocc, ocurrentcxnocc, scxnname, oconobjdef, nOptOrgElements)
{
