...
var g_applicationModelName = "Installations Map";                                    //Name of system library model
...
var g_applicationOrgCxnType = Constants.CT_BELONGS_TO_CLS;        //CUSTOM                          //Systems-Orgs relationship type (Org - can be user - System)

var g_parentCxnObjType = Constants.OT_APPL_SYS_CLS; //CUSTOM
...
function main(){
    ...
    if (workbookReader != null) {
        ...
        updateCxnLibraryModel(applicationModel)
...
function readImportExcel(sheet){
    ...
    for (row = 1; row < sheet.getLastFilledRowNum()+1; row++){
        ...
        //oObject.CreateCxnDef( ObjDef toObjDef, int cxnBaseTypeNum )
        var a=2
