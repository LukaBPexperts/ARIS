...
function main()
{
    ...
    var i1 = 0; 
    //oselectedobjdefs1 = ArisData.getSelectedObjDefs();
    //oselectedobjdefs1 = db.Find(Constants.SEARCH_OBJDEF);
    ...
    for( i1 = 0; i1 <= (oselectedobjdefs1.length - 1); i1++ ){
        ...
        if (oocclist1.length == 0) {
            g_ooutfile.TableRow();
            g_ooutfile.TableCell(oselectedobjdefs1obj.Name(g_nloc), 50, "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_LEFT | Constants.FMT_VTOP | Constants.FMT_ADDLINE | Constants.FMT_EXCELMODIFY, 0);
