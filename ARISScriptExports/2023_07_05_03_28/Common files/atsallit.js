...
function graphicdialogs(g_ooutfile, bcheckuserdialog)
{
  ...
  if (bcheckuserdialog.value) {
    ...
    while (binput == false) {
      var userdialog = Dialogs.createNewDialogTemplate(700, 310, "Formatta grafico", "GraphicDialogsFunc_Dlg1");      
      // %GRID:10,7,1,1
      userdialog.Text(10, 10, 460, 15, "Indica come configurare il grafico del modello.");
      userdialog.Text(10, 25, 460, 15, "Terminare la propria selezione con OK.");
      userdialog.GroupBox(7, 50, 686, 55, "Colore");
      userdialog.OptionGroup("options1");
      userdialog.OptionButton(20, 65, 580, 15, "Colorato");
      userdialog.OptionButton(20, 80, 580, 15, "Bianco-nero");
      userdialog.GroupBox(7, 120, 686, 85, "Proporzioni");
      userdialog.TextBox(200, 132, 60, 20, "Text0");
      userdialog.Text(280, 135, 50, 15, " %");
      userdialog.OptionGroup("options3");
      userdialog.OptionButton(20, 135, 180, 15, "Personalizzata");
      userdialog.OptionButton(20, 150, 80, 15, "100%");
      userdialog.OptionButton(20, 165, 580, 15, "Adatta alla pagina");
      userdialog.OptionButton(20, 182, 660, 15, "Scala di stampa modello");
      userdialog.GroupBox(7, 220, 686, 55, "Tagliare");
      userdialog.OptionGroup("options4");
      userdialog.OptionButton(20, 235, 580, 15, "Taglia oggetti ai bordi");
      userdialog.OptionButton(20, 250, 580, 15, "Sovrapporre oggetti ai bordi");
      userdialog.OKButton();
        ...
        if ( !(isNaN(dlg.getDlgText("Text0"))) ) {
          ...
          if (nscalevalue.value >= 10 && nscalevalue.value <= 400) {    // BLUE-10197 Adapted to the allowed values in Designer 
            binput = true;
                        ...
                        Dialogs.MsgBox("Inserisci valore cifra < 400.", 0, "Report");
          }

        }
        else {
                    Dialogs.MsgBox("Inserisci valore cifra.", 0, "Report");
        }
    ...
    if (! (nuserdlg1 == 0)) {
      ...
      // (No page settings for HTML output)
        ...
        while (binput == false) {
          ...
          var userdialog = Dialogs.createNewDialogTemplate(520, 280, "Report", "GraphicDialogsFunc_Dlg3");       // %GRID:10,7,1,1
          userdialog.Text(10, 10, 460, 15, "Indica il layout di pagina.");
          userdialog.Text(10, 25, 460, 15, "Terminare la propria selezione con OK.");
          userdialog.GroupBox(10, 49, 240, 180, "Margine di pagina");
          userdialog.Text(20, 70, 100, 15, "In alto");
          userdialog.TextBox(120, 67, 40, 20, "Text0");
          userdialog.Text(170, 70, 25, 15, "mm");
          userdialog.Text(20, 100, 100, 15, "In basso");
          userdialog.TextBox(120, 97, 40, 20, "Text2");
          userdialog.Text(170, 100, 25, 15, "mm");
          userdialog.Text(20, 130, 100, 15, "Sinistro");
          userdialog.TextBox(120, 127, 40, 20, "Text4");
          userdialog.Text(170, 130, 25, 15, "mm");
          userdialog.Text(20, 160, 100, 15, "Destro");
          userdialog.TextBox(120, 157, 40, 20, "Text5");
          userdialog.Text(170, 160, 25, 15, "mm");
          userdialog.GroupBox(270, 49, 240, 180, "Formato della carta");
          userdialog.DropListBox(280, 67, 220, 70, g_sPaperFormat, "VAR_PaperFormat");
          userdialog.Text(280, 100, 100, 14, "Larghezza");
          userdialog.TextBox(380, 97, 40, 21, "Text1");
          userdialog.Text(430, 100, 30, 14, "mm");
          userdialog.Text(280, 130, 100, 14, "Altezza");
          userdialog.TextBox(380, 127, 40, 21, "Text3");
          userdialog.Text(430, 130, 30, 14, "mm");
          userdialog.GroupBox(280, 155, 220, 55, "Orientamento");
          userdialog.OptionGroup("VAR_Orientation");
          userdialog.OptionButton(300, 170, 150, 15, "Verticale");
          userdialog.OptionButton(300, 190, 150, 15, "Orizzontale");
          userdialog.OKButton();
          userdialog.CancelButton();
...
function GraphicDialogsFunc_Dlg3(dlgitem, action, suppvalue)
{
  ...
  switch(action) {
    case 1:
      g_tPaperFormat[0] = new tPaperFormatType("Personalizzata", 0, 0);      // userdefined
      ...
      g_tPaperFormat[4] = new tPaperFormatType("Lettera", 216, 280);             // Letter
...
function extensionselect(sextension, bcheckuserdialog)
{
  ...
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 170, "Report");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "Non è possibile produrre il report con il formato indicato!");
  userdialog.Text(10, 25, 460, 15, "Seleziona un altro. Terminare la propria selezione con OK.");
  userdialog.GroupBox(7, 50, 686, 85, "Opzioni di stampa");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "Formato RTF (*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "File HTML (*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "File di testo (*.txt)");
...
function changeexgraph(g_ooutfile, bcheckuserdialog)
{
  ...
  var sextension = ""; 
  var sfilestring = ""; 
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 152, "Report");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "Con il formato indicato non è possibile produrre il report con la grafica!");
  userdialog.Text(10, 25, 460, 15, "Seleziona un altro. Terminare la propria selezione con OK.");
  userdialog.GroupBox(7, 50, 686, 67, "Opzioni di stampa");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "Formato RTF (*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "File HTML (*.htm)");
...
function outstatistic(omodels, srulenamelist, sobjstring, nstatistic, outputObject, nsemloc)
{
  ...
  while (nstart <= nmodelcount) {
    ...
    outputObject.TableCell((("Regola/" + sobjstring) + " No."), nfirstcellwidth, "Arial", 12, 0, 8421504, 0, 137, 0);
  ...
  outputObject.TableCell("Gruppo", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  // tablebody
  ...
  outputObject.EndTable(("Statistica - " + sobjstring), 100, "Arial", 10, 0, - 1, 0, 136, 0);
}
...
function setReportHeaderFooterWithTitle(outfile, nloc, bDisplayServer, bDisplayDatabase, bDisplayUser, sTitle)  // BLUE-11195
{
    ...
    outfile.Output(" di ", "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER, 0);
    ...
    if(bDisplayUser)
        outfile.OutputLnF(("Utente: " + ArisData.getActiveUser().Name(nloc)), "REPORT2");
