...
function graphicdialogs(g_ooutfile, bcheckuserdialog)
{
  ...
  if (bcheckuserdialog.value) {
    ...
    while (binput == false) {
      var userdialog = Dialogs.createNewDialogTemplate(700, 310, "تنسيق الرسم", "GraphicDialogsFunc_Dlg1");      
      // %GRID:10,7,1,1
      userdialog.Text(10, 10, 460, 15, "كيف تريد أن يتم عرض الرسم النموذج؟");
      userdialog.Text(10, 25, 460, 15, "انقر فوق &quot;موافق&quot; لإنهاء التحديد.");
      userdialog.GroupBox(7, 50, 686, 55, "اللون");
      userdialog.OptionGroup("options1");
      userdialog.OptionButton(20, 65, 580, 15, "اللون");
      userdialog.OptionButton(20, 80, 580, 15, "أسود وأبيض");
      userdialog.GroupBox(7, 120, 686, 85, "تغيير الحجم");
      userdialog.TextBox(200, 132, 60, 20, "Text0");
      userdialog.Text(280, 135, 50, 15, " %");
      userdialog.OptionGroup("options3");
      userdialog.OptionButton(20, 135, 180, 15, "معرّف من قبل المستخدم");
      userdialog.OptionButton(20, 150, 80, 15, "100%");
      userdialog.OptionButton(20, 165, 580, 15, "تغيير الحجم بما يلائم حجم الصفحة");
      userdialog.OptionButton(20, 182, 660, 15, "مقياس طباعة النموذج");
      userdialog.GroupBox(7, 220, 686, 55, "قص");
      userdialog.OptionGroup("options4");
      userdialog.OptionButton(20, 235, 580, 15, "قص الكائنات التي عند الهامش");
      userdialog.OptionButton(20, 250, 580, 15, "تراكب كائنات بعد الهامش");
      userdialog.OKButton();
        ...
        if ( !(isNaN(dlg.getDlgText("Text0"))) ) {
          ...
          if (nscalevalue.value >= 10 && nscalevalue.value <= 400) {    // BLUE-10197 Adapted to the allowed values in Designer 
            binput = true;
                        ...
                        Dialogs.MsgBox("الرجاء إدخال قيمة بين 10 و9.", 0, "تقرير");
          }

        }
        else {
                    Dialogs.MsgBox("الرجاء إدخال قيمة عدد صحيح.", 0, "تقرير");
        }
    ...
    if (! (nuserdlg1 == 0)) {
      ...
      // (No page settings for HTML output)
        ...
        while (binput == false) {
          ...
          var userdialog = Dialogs.createNewDialogTemplate(520, 280, "تقرير", "GraphicDialogsFunc_Dlg3");       // %GRID:10,7,1,1
          userdialog.Text(10, 10, 460, 15, "الرجاء تحديد تخطيط الصفحة.");
          userdialog.Text(10, 25, 460, 15, "انقر فوق &quot;موافق&quot; لإنهاء التحديد.");
          userdialog.GroupBox(10, 49, 240, 180, "الهوامش");
          userdialog.Text(20, 70, 100, 15, "أعلى");
          userdialog.TextBox(120, 67, 40, 20, "Text0");
          userdialog.Text(170, 70, 25, 15, "ملم");
          userdialog.Text(20, 100, 100, 15, "أسفل");
          userdialog.TextBox(120, 97, 40, 20, "Text2");
          userdialog.Text(170, 100, 25, 15, "ملم");
          userdialog.Text(20, 130, 100, 15, "يسار");
          userdialog.TextBox(120, 127, 40, 20, "Text4");
          userdialog.Text(170, 130, 25, 15, "ملم");
          userdialog.Text(20, 160, 100, 15, "يمين");
          userdialog.TextBox(120, 157, 40, 20, "Text5");
          userdialog.Text(170, 160, 25, 15, "ملم");
          userdialog.GroupBox(270, 49, 240, 180, "تنسيق الورق");
          userdialog.DropListBox(280, 67, 220, 70, g_sPaperFormat, "VAR_PaperFormat");
          userdialog.Text(280, 100, 100, 14, "العرض");
          userdialog.TextBox(380, 97, 40, 21, "Text1");
          userdialog.Text(430, 100, 30, 14, "ملم");
          userdialog.Text(280, 130, 100, 14, "الارتفاع");
          userdialog.TextBox(380, 127, 40, 21, "Text3");
          userdialog.Text(430, 130, 30, 14, "ملم");
          userdialog.GroupBox(280, 155, 220, 55, "الاتجاه");
          userdialog.OptionGroup("VAR_Orientation");
          userdialog.OptionButton(300, 170, 150, 15, "عمودي");
          userdialog.OptionButton(300, 190, 150, 15, "أفقي");
          userdialog.OKButton();
          userdialog.CancelButton();
...
function GraphicDialogsFunc_Dlg3(dlgitem, action, suppvalue)
{
  ...
  switch(action) {
    case 1:
      g_tPaperFormat[0] = new tPaperFormatType("معرّف من قبل المستخدم", 0, 0);      // userdefined
      ...
      g_tPaperFormat[4] = new tPaperFormatType("رسالة", 216, 280);             // Letter
...
function extensionselect(sextension, bcheckuserdialog)
{
  ...
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 170, "تقرير");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "The selected output option cannot be used to create the report.");
  userdialog.Text(10, 25, 460, 15, "الرجاء تحديد تبويب التحليل. انقر فوق 'موافق' لإنهاء التحديد.");
  userdialog.GroupBox(7, 50, 686, 85, "خيارات المخرجات");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "Rich Text Format‏ (*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "HTML File ‏(*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "Text File ‏(*.txt)");
  userdialog.OptionButton(20, 110, 580, 15, "Word Document (*.doc)");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function changeexgraph(g_ooutfile, bcheckuserdialog)
{
  ...
  var sextension = ""; 
  var sfilestring = ""; 
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 152, "تقرير");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "The selected output option cannot be used to create the report with graphic.");
  userdialog.Text(10, 25, 460, 15, "الرجاء تحديد تبويب التحليل. انقر فوق 'موافق' لإنهاء التحديد.");
  userdialog.GroupBox(7, 50, 686, 67, "خيارات المخرجات");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "Rich Text Format‏ (*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "HTML File ‏(*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "Word Document (*.doc)");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function outstatistic(omodels, srulenamelist, sobjstring, nstatistic, outputObject, nsemloc)
{
  ...
  while (nstart <= nmodelcount) {
    ...
    outputObject.TableCell((("قاعدة/" + sobjstring) + " رقم"), nfirstcellwidth, "Arial", 12, 0, 8421504, 0, 137, 0);
  ...
  // tablehead
  outputObject.TableRow();
  outputObject.TableCell((sobjstring + " رقم"), 10, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("الاسم", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("النوع", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("المجموعة", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  // tablebody
  ...
  outputObject.EndTable(("إحصائيات - " + sobjstring), 100, "Arial", 10, 0, - 1, 0, 136, 0);
}
...
function setReportHeaderFooterWithTitle(outfile, nloc, bDisplayServer, bDisplayDatabase, bDisplayUser, sTitle)  // BLUE-11195
{
    ...
    outfile.TableCell("", 26, "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_CENTER | Constants.FMT_VCENTER, 0);
    outfile.Output("الصفحة ", "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER, 0);
    outfile.OutputField(Constants.FIELD_PAGE, "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER);
    outfile.Output(" من ", "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER, 0);
    ...
    if(bDisplayServer)
        outfile.OutputLnF(("الخادم: " + ArisData.getActiveDatabase().ServerName()), "REPORT2");
    
    if(bDisplayDatabase)
        outfile.OutputLnF(("قاعدة البيانات: " + ArisData.getActiveDatabase().Name(nloc)), "REPORT2");
    
    if(bDisplayUser)
        outfile.OutputLnF(("المستخدم: " + ArisData.getActiveUser().Name(nloc)), "REPORT2");
