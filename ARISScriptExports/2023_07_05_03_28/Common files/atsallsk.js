...
function graphicdialogs(g_ooutfile, bcheckuserdialog)
{
  ...
  if (bcheckuserdialog.value) {
    ...
    while (binput == false) {
      var userdialog = Dialogs.createNewDialogTemplate(700, 310, "Formátovať grafiku", "GraphicDialogsFunc_Dlg1");      
      // %GRID:10,7,1,1
      userdialog.Text(10, 10, 460, 15, "Použite nasledujúce voľby pre zobrazenie obrázku modelu.");
      userdialog.Text(10, 25, 460, 15, "Kliknite na OK pre ukončenie vášho výberu.");
      userdialog.GroupBox(7, 50, 686, 55, "Farba");
      userdialog.OptionGroup("options1");
      userdialog.OptionButton(20, 65, 580, 15, "Farebný");
      userdialog.OptionButton(20, 80, 580, 15, "Čiernobiele");
      userdialog.GroupBox(7, 120, 686, 85, "Mierka");
      userdialog.TextBox(200, 132, 60, 20, "Text0");
      userdialog.Text(280, 135, 50, 15, " %");
      userdialog.OptionGroup("options3");
      userdialog.OptionButton(20, 135, 180, 15, "Používateľská");
      userdialog.OptionButton(20, 150, 80, 15, "100%");
      userdialog.OptionButton(20, 165, 580, 15, "Prispôsobiť stranu");
      userdialog.OptionButton(20, 182, 660, 15, "Mierka tlače modelu");
      userdialog.GroupBox(7, 220, 686, 55, "Odstrihnúť");
      userdialog.OptionGroup("options4");
      userdialog.OptionButton(20, 235, 580, 15, "Odstrihnúť objekty na okraji");
      userdialog.OptionButton(20, 250, 580, 15, "Prelož objekty cez okraj");
      userdialog.OKButton();
        ...
        if ( !(isNaN(dlg.getDlgText("Text0"))) ) {
          ...
          if (nscalevalue.value >= 10 && nscalevalue.value <= 400) {    // BLUE-10197 Adapted to the allowed values in Designer 
            binput = true;
                        ...
                        Dialogs.MsgBox("Zadajte hodnotu medzi 10 a 400.", 0, "Zostava");
          }

        }
        else {
                    Dialogs.MsgBox("Zadajte hodnotu.", 0, "Zostava");
        }
    ...
    if (! (nuserdlg1 == 0)) {
      ...
      // (No page settings for HTML output)
        ...
        while (binput == false) {
          ...
          var userdialog = Dialogs.createNewDialogTemplate(520, 280, "Zostava", "GraphicDialogsFunc_Dlg3");       // %GRID:10,7,1,1
          userdialog.Text(10, 10, 460, 15, "Vyberte formát papiera.");
          userdialog.Text(10, 25, 460, 15, "Kliknite na OK pre ukončenie vášho výberu.");
          userdialog.GroupBox(10, 49, 240, 180, "Okraje");
          userdialog.Text(20, 70, 100, 15, "Hore");
          userdialog.TextBox(120, 67, 40, 20, "Text0");
          userdialog.Text(170, 70, 25, 15, "mm");
          userdialog.Text(20, 100, 100, 15, "Dole");
          userdialog.TextBox(120, 97, 40, 20, "Text2");
          userdialog.Text(170, 100, 25, 15, "mm");
          userdialog.Text(20, 130, 100, 15, "Vľavo");
          userdialog.TextBox(120, 127, 40, 20, "Text4");
          userdialog.Text(170, 130, 25, 15, "mm");
          userdialog.Text(20, 160, 100, 15, "Vpravo");
          userdialog.TextBox(120, 157, 40, 20, "Text5");
          userdialog.Text(170, 160, 25, 15, "mm");
          userdialog.GroupBox(270, 49, 240, 180, "Formát stránky");
          userdialog.DropListBox(280, 67, 220, 70, g_sPaperFormat, "VAR_PaperFormat");
          userdialog.Text(280, 100, 100, 14, "Šírka");
          userdialog.TextBox(380, 97, 40, 21, "Text1");
          userdialog.Text(430, 100, 30, 14, "mm");
          userdialog.Text(280, 130, 100, 14, "Výška");
          userdialog.TextBox(380, 127, 40, 21, "Text3");
          userdialog.Text(430, 130, 30, 14, "mm");
          userdialog.GroupBox(280, 155, 220, 55, "Orientácia");
          userdialog.OptionGroup("VAR_Orientation");
          userdialog.OptionButton(300, 170, 150, 15, "Na výšku");
          userdialog.OptionButton(300, 190, 150, 15, "Na šírku");
          userdialog.OKButton();
          userdialog.CancelButton();
...
function GraphicDialogsFunc_Dlg3(dlgitem, action, suppvalue)
{
  ...
  switch(action) {
    case 1:
      g_tPaperFormat[0] = new tPaperFormatType("Používateľská", 0, 0);      // userdefined
...
function extensionselect(sextension, bcheckuserdialog)
{
  ...
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 170, "Zostava");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "Zostavu je možné vytvoriť s vybranými parametrami.");
  userdialog.Text(10, 25, 460, 15, "Vyberte nové parametre. Kliknite na OK pre ukončenie vášho výberu.");
  userdialog.GroupBox(7, 50, 686, 85, "Parametre výstupu");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "Formát RTF (*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "HTML súbor (*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "Textový súbor (*.txt)");
...
function changeexgraph(g_ooutfile, bcheckuserdialog)
{
  ...
  var sextension = ""; 
  var sfilestring = ""; 
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 152, "Zostava");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "Zostavu je možné vytvoriť s obrázkom pri použití vybraných parametrov.");
  userdialog.Text(10, 25, 460, 15, "Vyberte nové parametre. Kliknite na OK pre ukončenie vášho výberu.");
  userdialog.GroupBox(7, 50, 686, 67, "Parametre výstupu");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "Formát RTF (*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "HTML súbor (*.htm)");
...
function outstatistic(omodels, srulenamelist, sobjstring, nstatistic, outputObject, nsemloc)
{
  ...
  while (nstart <= nmodelcount) {
    ...
    outputObject.TableCell((("Pravidlo/" + sobjstring) + " Čís."), nfirstcellwidth, "Arial", 12, 0, 8421504, 0, 137, 0);
    ...
    ssheetname = "Štatistiky - Pravidlá";
    if ((nindex > 1)) {
  ...
  // tablehead
  outputObject.TableRow();
  outputObject.TableCell((sobjstring + " Čís."), 10, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("Názov", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("Typ", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("Skupina", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  // tablebody
  ...
  outputObject.EndTable(("Štatistiky - " + sobjstring), 100, "Arial", 10, 0, - 1, 0, 136, 0);
}
...
function setReportHeaderFooterWithTitle(outfile, nloc, bDisplayServer, bDisplayDatabase, bDisplayUser, sTitle)  // BLUE-11195
{
    ...
    outfile.TableCell("", 26, "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_CENTER | Constants.FMT_VCENTER, 0);
    outfile.Output("Strana ", "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER, 0);
    ...
    if(bDisplayDatabase)
        outfile.OutputLnF(("Databáza: " + ArisData.getActiveDatabase().Name(nloc)), "REPORT2");
    
    if(bDisplayUser)
        outfile.OutputLnF(("Používateľ: " + ArisData.getActiveUser().Name(nloc)), "REPORT2");
