...
function graphicdialogs(g_ooutfile, bcheckuserdialog)
{
  ...
  if (bcheckuserdialog.value) {
    ...
    while (binput == false) {
      var userdialog = Dialogs.createNewDialogTemplate(700, 310, "Muotoile grafiikka", "GraphicDialogsFunc_Dlg1");      
      // %GRID:10,7,1,1
      userdialog.Text(10, 10, 460, 15, "Miten malligrafiikan esitetään?");
      userdialog.Text(10, 25, 460, 15, "Päätä valinta napsauttamalla OK.");
      userdialog.GroupBox(7, 50, 686, 55, "Väri");
      userdialog.OptionGroup("options1");
      userdialog.OptionButton(20, 65, 580, 15, "Väri");
      userdialog.OptionButton(20, 80, 580, 15, "Mustavalkoinen");
      userdialog.GroupBox(7, 120, 686, 85, "Skaalaus");
      userdialog.TextBox(200, 132, 60, 20, "Text0");
      userdialog.Text(280, 135, 50, 15, " %");
      userdialog.OptionGroup("options3");
      userdialog.OptionButton(20, 135, 180, 15, "Käyttäjän määrittämä");
      userdialog.OptionButton(20, 150, 80, 15, "100%");
      userdialog.OptionButton(20, 165, 580, 15, "Sovita sivulle");
      userdialog.OptionButton(20, 182, 660, 15, "Mallin tulostusskaalaus");
      userdialog.GroupBox(7, 220, 686, 55, "Leikkaa");
      userdialog.OptionGroup("options4");
      userdialog.OptionButton(20, 235, 580, 15, "Leikkaa objektit reunasta");
      userdialog.OptionButton(20, 250, 580, 15, "Limitä objektit reunasta");
      userdialog.OKButton();
        ...
        if ( !(isNaN(dlg.getDlgText("Text0"))) ) {
          ...
          if (nscalevalue.value >= 10 && nscalevalue.value <= 400) {    // BLUE-10197 Adapted to the allowed values in Designer 
            binput = true;
                        ...
                        Dialogs.MsgBox("Syötä lukuarvot, jotka ovat < 400.", 0, "Raportti");
          }

        }
        else {
                    Dialogs.MsgBox("Syötä lukuarvot.", 0, "Raportti");
        }
    ...
    if (! (nuserdlg1 == 0)) {
      ...
      // (No page settings for HTML output)
        ...
        while (binput == false) {
          ...
          var userdialog = Dialogs.createNewDialogTemplate(520, 280, "Raportti", "GraphicDialogsFunc_Dlg3");       // %GRID:10,7,1,1
          userdialog.Text(10, 10, 460, 15, "Syötä sivun asettelu.");
          userdialog.Text(10, 25, 460, 15, "Päätä valinta napsauttamalla OK.");
          userdialog.GroupBox(10, 49, 240, 180, "Sivun reunukset");
          userdialog.Text(20, 70, 100, 15, "Yläreunaan");
          userdialog.TextBox(120, 67, 40, 20, "Text0");
          userdialog.Text(170, 70, 25, 15, "mm");
          userdialog.Text(20, 100, 100, 15, "Alareunaan");
          userdialog.TextBox(120, 97, 40, 20, "Text2");
          userdialog.Text(170, 100, 25, 15, "mm");
          userdialog.Text(20, 130, 100, 15, "Vasemmalle");
          userdialog.TextBox(120, 127, 40, 20, "Text4");
          userdialog.Text(170, 130, 25, 15, "mm");
          userdialog.Text(20, 160, 100, 15, "Oikealle");
          userdialog.TextBox(120, 157, 40, 20, "Text5");
          userdialog.Text(170, 160, 25, 15, "mm");
          userdialog.GroupBox(270, 49, 240, 180, "Paperin koko");
          userdialog.DropListBox(280, 67, 220, 70, g_sPaperFormat, "VAR_PaperFormat");
          userdialog.Text(280, 100, 100, 14, "Leveys");
          userdialog.TextBox(380, 97, 40, 21, "Text1");
          userdialog.Text(430, 100, 30, 14, "mm");
          userdialog.Text(280, 130, 100, 14, "Korkeus");
          userdialog.TextBox(380, 127, 40, 21, "Text3");
          userdialog.Text(430, 130, 30, 14, "mm");
          userdialog.GroupBox(280, 155, 220, 55, "Suunta");
          userdialog.OptionGroup("VAR_Orientation");
          userdialog.OptionButton(300, 170, 150, 15, "Pysty");
          userdialog.OptionButton(300, 190, 150, 15, "Vaaka");
          userdialog.OKButton();
          userdialog.CancelButton();
...
function GraphicDialogsFunc_Dlg3(dlgitem, action, suppvalue)
{
  ...
  switch(action) {
    case 1:
      g_tPaperFormat[0] = new tPaperFormatType("Käyttäjän määrittämä", 0, 0);      // userdefined
...
function extensionselect(sextension, bcheckuserdialog)
{
  ...
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 170, "Raportti");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "Raporttia ei voi luoda valituilla tulostusasetuksilla.");
  userdialog.Text(10, 25, 460, 15, "Valitse uudet asetukset. Päätä valinta napsauttamalla OK.");
  userdialog.GroupBox(7, 50, 686, 85, "Tulostusasetukset");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "Rich Text Format (*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "HTML Tiedosto (*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "Tekstitiedosto (*.txt)");
  userdialog.OptionButton(20, 110, 580, 15, "Word-asiakirja (*.doc)");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function changeexgraph(g_ooutfile, bcheckuserdialog)
{
  ...
  var sextension = ""; 
  var sfilestring = ""; 
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 152, "Raportti");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "Raporttia, jossa on grafiikkaa, ei voi luoda valituilla tulostusasetuksilla.");
  userdialog.Text(10, 25, 460, 15, "Valitse uudet asetukset. Päätä valinta napsauttamalla OK.");
  userdialog.GroupBox(7, 50, 686, 67, "Tulostusasetukset");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "Rich Text Format (*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "HTML Tiedosto (*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "Word-asiakirja (*.doc)");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function outstatistic(omodels, srulenamelist, sobjstring, nstatistic, outputObject, nsemloc)
{
  ...
  while (nstart <= nmodelcount) {
    ...
    outputObject.TableCell((("Sääntö/" + sobjstring) + " Nro"), nfirstcellwidth, "Arial", 12, 0, 8421504, 0, 137, 0);
  ...
  // tablehead
  outputObject.TableRow();
  outputObject.TableCell((sobjstring + " Nro"), 10, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("Nimi", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("Tyyppi", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("Ryhmä", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  // tablebody
  ...
  outputObject.EndTable(("Tilasto - " + sobjstring), 100, "Arial", 10, 0, - 1, 0, 136, 0);
}
...
function setReportHeaderFooterWithTitle(outfile, nloc, bDisplayServer, bDisplayDatabase, bDisplayUser, sTitle)  // BLUE-11195
{
    ...
    outfile.TableCell("", 26, "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_CENTER | Constants.FMT_VCENTER, 0);
    outfile.Output("Sivu ", "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER, 0);
    ...
    if(bDisplayServer)
        outfile.OutputLnF(("Palvelin: " + ArisData.getActiveDatabase().ServerName()), "REPORT2");
    
    if(bDisplayDatabase)
        outfile.OutputLnF(("Tietokanta: " + ArisData.getActiveDatabase().Name(nloc)), "REPORT2");
    
    if(bDisplayUser)
        outfile.OutputLnF(("Käyttäjä: " + ArisData.getActiveUser().Name(nloc)), "REPORT2");
