...
function graphicdialogs(g_ooutfile, bcheckuserdialog)
{
  ...
  if (bcheckuserdialog.value) {
    ...
    while (binput == false) {
      var userdialog = Dialogs.createNewDialogTemplate(700, 310, "Grafik formatieren", "GraphicDialogsFunc_Dlg1");      
      // %GRID:10,7,1,1
      userdialog.Text(10, 10, 460, 15, "Wie soll die Modellgrafik dargestellt werden?");
      userdialog.Text(10, 25, 460, 15, "Beenden Sie Ihre Auswahl mit 'OK'.");
      userdialog.GroupBox(7, 50, 686, 55, "Farbe");
      userdialog.OptionGroup("options1");
      userdialog.OptionButton(20, 65, 580, 15, "Farbig");
      userdialog.OptionButton(20, 80, 580, 15, "Schwarz-Weiß");
      userdialog.GroupBox(7, 120, 686, 85, "Skalierung");
      userdialog.TextBox(200, 132, 60, 20, "Text0");
      userdialog.Text(280, 135, 50, 15, " %");
      userdialog.OptionGroup("options3");
      userdialog.OptionButton(20, 135, 180, 15, "Benutzerdefiniert");
      userdialog.OptionButton(20, 150, 80, 15, "100%");
      userdialog.OptionButton(20, 165, 580, 15, "An Seitengröße anpassen");
      userdialog.OptionButton(20, 182, 660, 15, "Druckskalierung der Modelle");
      userdialog.GroupBox(7, 220, 686, 55, "Schneiden");
      userdialog.OptionGroup("options4");
      userdialog.OptionButton(20, 235, 580, 15, "Objekte am Rand schneiden");
      userdialog.OptionButton(20, 250, 580, 15, "Objekte am Rand überlappen");
      userdialog.OKButton();
        ...
        if ( !(isNaN(dlg.getDlgText("Text0"))) ) {
          ...
          if (nscalevalue.value >= 10 && nscalevalue.value <= 400) {    // BLUE-10197 Adapted to the allowed values in Designer 
            binput = true;
                        ...
                        Dialogs.MsgBox("Bitte einen Zahlenwerte zwischen 10 und 400 eingeben.", 0, "Report");
          }

        }
        else {
                    Dialogs.MsgBox("Bitte Zahlenwerte eingeben.", 0, "Report");
        }
    ...
    if (! (nuserdlg1 == 0)) {
      ...
      // (No page settings for HTML output)
        ...
        while (binput == false) {
          ...
          userdialog.Text(10, 10, 460, 15, "Bitte geben Sie das Seitenlayout an.");
          userdialog.Text(10, 25, 460, 15, "Beenden Sie Ihre Auswahl mit 'OK'.");
          userdialog.GroupBox(10, 49, 240, 180, "Seitenränder");
          userdialog.Text(20, 70, 100, 15, "Oben");
          userdialog.TextBox(120, 67, 40, 20, "Text0");
          userdialog.Text(170, 70, 25, 15, "mm");
          userdialog.Text(20, 100, 100, 15, "Unten");
          ...
          userdialog.GroupBox(270, 49, 240, 180, "Papierformat");
          userdialog.DropListBox(280, 67, 220, 70, g_sPaperFormat, "VAR_PaperFormat");
          userdialog.Text(280, 100, 100, 14, "Breite");
          userdialog.TextBox(380, 97, 40, 21, "Text1");
          userdialog.Text(430, 100, 30, 14, "mm");
          userdialog.Text(280, 130, 100, 14, "Höhe");
          userdialog.TextBox(380, 127, 40, 21, "Text3");
          userdialog.Text(430, 130, 30, 14, "mm");
          userdialog.GroupBox(280, 155, 220, 55, "Ausrichtung");
          userdialog.OptionGroup("VAR_Orientation");
          userdialog.OptionButton(300, 170, 150, 15, "Hochformat");
          userdialog.OptionButton(300, 190, 150, 15, "Querformat");
          userdialog.OKButton();
          userdialog.CancelButton();
...
function GraphicDialogsFunc_Dlg3(dlgitem, action, suppvalue)
{
  ...
  switch(action) {
    case 1:
      g_tPaperFormat[0] = new tPaperFormatType("Benutzerdefiniert", 0, 0);      // userdefined
...
function extensionselect(sextension, bcheckuserdialog)
{
  ...
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "Mit der gewählten Ausgabeoption kann der Report nicht erstellt werden!");
  userdialog.Text(10, 25, 460, 15, "Bitte wählen Sie eine andere Option. Beenden Sie Ihre Auswahl mit 'OK'.");
  userdialog.GroupBox(7, 50, 686, 85, "Ausgabeoptionen");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "Rich Text Format (*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "HTML-Datei (*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "Textdatei (*.txt)");
  userdialog.OptionButton(20, 110, 580, 15, "Word-Dokument (*.doc)");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function changeexgraph(g_ooutfile, bcheckuserdialog)
{
  ...
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "Mit der gewählten Ausgabeoption kann der Report mit Grafik nicht erstellt werden!");
  userdialog.Text(10, 25, 460, 15, "Bitte wählen Sie eine andere Option. Beenden Sie Ihre Auswahl mit 'OK'.");
  userdialog.GroupBox(7, 50, 686, 67, "Ausgabeoptionen");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "Rich Text Format (*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "HTML-Datei (*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "Word-Dokument (*.doc)");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function outstatistic(omodels, srulenamelist, sobjstring, nstatistic, outputObject, nsemloc)
{
  ...
  outputObject.TableCell("Gruppe", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  // tablebody
  ...
  outputObject.EndTable(("Statistik - " + sobjstring), 100, "Arial", 10, 0, - 1, 0, 136, 0);
}
...
function setReportHeaderFooterWithTitle(outfile, nloc, bDisplayServer, bDisplayDatabase, bDisplayUser, sTitle)  // BLUE-11195
{
    ...
    if(bDisplayDatabase)
        outfile.OutputLnF(("Datenbank: " + ArisData.getActiveDatabase().Name(nloc)), "REPORT2");
    
    if(bDisplayUser)
        outfile.OutputLnF(("Benutzer: " + ArisData.getActiveUser().Name(nloc)), "REPORT2");
