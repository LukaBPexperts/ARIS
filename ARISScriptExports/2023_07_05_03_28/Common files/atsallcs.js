...
function graphicdialogs(g_ooutfile, bcheckuserdialog)
{
  ...
  if (bcheckuserdialog.value) {
    ...
    while (binput == false) {
      var userdialog = Dialogs.createNewDialogTemplate(700, 310, "Formátovat obrázek", "GraphicDialogsFunc_Dlg1");      
      // %GRID:10,7,1,1
      userdialog.Text(10, 10, 460, 15, "Využijte následujících nastavení pro zobrazení obrázku.");
      userdialog.Text(10, 25, 460, 15, "Výběr ukončíte stiskem tlačítka OK.");
      userdialog.GroupBox(7, 50, 686, 55, "Barva");
      userdialog.OptionGroup("options1");
      userdialog.OptionButton(20, 65, 580, 15, "Barevný");
      userdialog.OptionButton(20, 80, 580, 15, "Černobíle");
      userdialog.GroupBox(7, 120, 686, 85, "Měřítko");
      userdialog.TextBox(200, 132, 60, 20, "Text0");
      userdialog.Text(280, 135, 50, 15, " %");
      userdialog.OptionGroup("options3");
      userdialog.OptionButton(20, 135, 180, 15, "Uživatelem definované");
      userdialog.OptionButton(20, 150, 80, 15, "100%");
      userdialog.OptionButton(20, 165, 580, 15, "Na stránku");
      userdialog.OptionButton(20, 182, 660, 15, "Měřítko modelu");
      userdialog.GroupBox(7, 220, 686, 55, "Ořezávání");
      userdialog.OptionGroup("options4");
      userdialog.OptionButton(20, 235, 580, 15, "Oříznout objekty na okraji");
      userdialog.OptionButton(20, 250, 580, 15, "Nechat přesáhnout objekty na okraji");
      userdialog.OKButton();
...
//      userdialog.HelpButton("HID_atsall_dlg_01.hlp");
      ...
      if (dlg.getDlgValue("options3") == 0) {
        if ( !(isNaN(dlg.getDlgText("Text0"))) ) {
          ...
          if (nscalevalue.value > 0) {
            binput = true;
          }
          else {
                        Dialogs.MsgBox("Zadejte hodnotu > 0.", 0, "Sestava");
          }

        }
        else {
                    Dialogs.MsgBox("Zadejte hodnotu.", 0, "Sestava");
        }
    ...
    if (! (nuserdlg1 == 0)) {
      ...
      // (No page settings for HTML output)
        ...
        while (binput == false) {
          ...
          var userdialog = Dialogs.createNewDialogTemplate(520, 280, "Sestava", "GraphicDialogsFunc_Dlg3");       // %GRID:10,7,1,1
          userdialog.Text(10, 10, 460, 15, "Vyberte rozvržení na stránce.");
          userdialog.Text(10, 25, 460, 15, "Výběr ukončíte stiskem tlačítka OK.");
          userdialog.GroupBox(10, 49, 240, 180, "Okraje");
          userdialog.Text(20, 70, 100, 15, "Nahoře");
          ...
          userdialog.Text(20, 130, 100, 15, "Vlevo");
          ...
          userdialog.GroupBox(270, 49, 240, 180, "Velikost stránky");
          userdialog.DropListBox(280, 67, 220, 70, g_sPaperFormat, "VAR_PaperFormat");
          userdialog.Text(280, 100, 100, 14, "Šířka");
          ...
          userdialog.GroupBox(280, 155, 220, 55, "Orientace");
          userdialog.OptionGroup("VAR_Orientation");
          userdialog.OptionButton(300, 170, 150, 15, "Na výšku");
          userdialog.OptionButton(300, 190, 150, 15, "Na šířku");
          userdialog.OKButton();
          userdialog.CancelButton();
...
function GraphicDialogsFunc_Dlg3(dlgitem, action, suppvalue)
{
  ...
  switch(action) {
    case 1:
      g_tPaperFormat[0] = new tPaperFormatType("Uživatelem definované", 0, 0);      // userdefined
...
function extensionselect(sextension, bcheckuserdialog)
{
  ...
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 170, "Sestava");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "Nebylo možné vytvořit pro formát!");
  userdialog.Text(10, 25, 460, 15, "Vyberte novou možnost. Výběr ukončíte stiskem tlačítka OK.");
  userdialog.GroupBox(7, 50, 686, 85, "Možnosti zobrazení");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "Formát RTF (*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "Soubor HTML (*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "Textový soubor (*.txt)");
  userdialog.OptionButton(20, 110, 580, 15, "Dokument Word (*.doc)");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function changeexgraph(g_ooutfile, bcheckuserdialog)
{
  ...
  var sextension = ""; 
  var sfilestring = ""; 
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 152, "Sestava");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "Nebylo možné vytvořit obrázek pro formát!");
  userdialog.Text(10, 25, 460, 15, "Vyberte novou možnost. Výběr ukončíte stiskem tlačítka OK.");
  userdialog.GroupBox(7, 50, 686, 67, "Možnosti zobrazení");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "Formát RTF (*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "Soubor HTML (*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "Dokument Word (*.doc)");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function outstatistic(omodels, srulenamelist, sobjstring, nstatistic, outputObject, nsemloc)
{
  ...
  while (nstart <= nmodelcount) {
    ...
    outputObject.TableCell((("Pravidlo/" + sobjstring) + " Č."), nfirstcellwidth, "Arial", 12, 0, 8421504, 0, 137, 0);
    ...
    ssheetname = "Statistika - Pravidla";
    if ((nindex > 1)) {
  ...
  // tablehead
  outputObject.TableRow();
  outputObject.TableCell((sobjstring + " Č."), 10, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("Název", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  ...
  outputObject.EndTable(("Statistika - " + sobjstring), 100, "Arial", 10, 0, - 1, 0, 136, 0);
}
...
function setReportHeaderFooterWithTitle(outfile, nloc, bDisplayServer, bDisplayDatabase, bDisplayUser, sTitle)  // BLUE-11195
{
    ...
    outfile.TableCell("", 26, "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_CENTER | Constants.FMT_VCENTER, 0);
    outfile.Output("Stránka ", "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER, 0);
    ...
    if(bDisplayDatabase)
        outfile.OutputLnF(("Databáze: " + ArisData.getActiveDatabase().Name(nloc)), "REPORT2");
    
    if(bDisplayUser)
        outfile.OutputLnF(("Uživatel: " + ArisData.getActiveUser().Name(nloc)), "REPORT2");
