...
function graphicdialogs(g_ooutfile, bcheckuserdialog)
{
  ...
  if (bcheckuserdialog.value) {
    ...
    while (binput == false) {
      var userdialog = Dialogs.createNewDialogTemplate(700, 310, "Форматировать графику", "GraphicDialogsFunc_Dlg1");      
      // %GRID:10,7,1,1
      userdialog.Text(10, 10, 460, 15, "Используйте следующие параметры для настройки изображения модели.");
      userdialog.Text(10, 25, 460, 15, "Нажмите ОК для завершения выбора.");
      userdialog.GroupBox(7, 50, 686, 55, "Цвет");
      userdialog.OptionGroup("options1");
      userdialog.OptionButton(20, 65, 580, 15, "Цветное");
      userdialog.OptionButton(20, 80, 580, 15, "Черно-белое");
      userdialog.GroupBox(7, 120, 686, 85, "Масштаб");
      userdialog.TextBox(200, 132, 60, 20, "Text0");
      userdialog.Text(280, 135, 50, 15, " %");
      userdialog.OptionGroup("options3");
      userdialog.OptionButton(20, 135, 180, 15, "Пользовательский");
      userdialog.OptionButton(20, 150, 80, 15, "100%");
      userdialog.OptionButton(20, 165, 580, 15, "Подогнать под размер страницы");
      userdialog.OptionButton(20, 182, 660, 15, "Масштабирование печати модели");
      userdialog.GroupBox(7, 220, 686, 55, "Вырезать");
      userdialog.OptionGroup("options4");
      userdialog.OptionButton(20, 235, 580, 15, "Вырезать объекты на границе");
      userdialog.OptionButton(20, 250, 580, 15, "Использовать объекты, лежащие за границами");
      userdialog.OKButton();
        ...
        if ( !(isNaN(dlg.getDlgText("Text0"))) ) {
          ...
          if (nscalevalue.value >= 10 && nscalevalue.value <= 400) {    // BLUE-10197 Adapted to the allowed values in Designer 
            binput = true;
                        ...
                        Dialogs.MsgBox("Введите число между 10 и 400.", 0, "Отчет");
          }

        }
        else {
                    Dialogs.MsgBox("Введите число.", 0, "Отчет");
        }
    ...
    if (! (nuserdlg1 == 0)) {
      ...
      // (No page settings for HTML output)
        ...
        while (binput == false) {
          ...
          var userdialog = Dialogs.createNewDialogTemplate(520, 280, "Отчет", "GraphicDialogsFunc_Dlg3");       // %GRID:10,7,1,1
          userdialog.Text(10, 10, 460, 15, "Выберите разметку страницы.");
          userdialog.Text(10, 25, 460, 15, "Нажмите ОК для завершения выбора.");
          userdialog.GroupBox(10, 49, 240, 180, "Поля");
          userdialog.Text(20, 70, 100, 15, "Вверху");
          userdialog.TextBox(120, 67, 40, 20, "Text0");
          userdialog.Text(170, 70, 25, 15, "mm");
          userdialog.Text(20, 100, 100, 15, "Внизу");
          userdialog.TextBox(120, 97, 40, 20, "Text2");
          userdialog.Text(170, 100, 25, 15, "mm");
          userdialog.Text(20, 130, 100, 15, "Слева");
          userdialog.TextBox(120, 127, 40, 20, "Text4");
          userdialog.Text(170, 130, 25, 15, "mm");
          userdialog.Text(20, 160, 100, 15, "Справа");
          userdialog.TextBox(120, 157, 40, 20, "Text5");
          userdialog.Text(170, 160, 25, 15, "mm");
          userdialog.GroupBox(270, 49, 240, 180, "Формат бумаги");
          userdialog.DropListBox(280, 67, 220, 70, g_sPaperFormat, "VAR_PaperFormat");
          userdialog.Text(280, 100, 100, 14, "Ширина");
          userdialog.TextBox(380, 97, 40, 21, "Text1");
          userdialog.Text(430, 100, 30, 14, "mm");
          userdialog.Text(280, 130, 100, 14, "Высота");
          userdialog.TextBox(380, 127, 40, 21, "Text3");
          userdialog.Text(430, 130, 30, 14, "mm");
          userdialog.GroupBox(280, 155, 220, 55, "Ориентация");
          userdialog.OptionGroup("VAR_Orientation");
          userdialog.OptionButton(300, 170, 150, 15, "Книжная");
          userdialog.OptionButton(300, 190, 150, 15, "Альбомная");
          userdialog.OKButton();
          userdialog.CancelButton();
...
function GraphicDialogsFunc_Dlg3(dlgitem, action, suppvalue)
{
  ...
  switch(action) {
    case 1:
      g_tPaperFormat[0] = new tPaperFormatType("Пользовательский", 0, 0);      // userdefined
      ...
      g_tPaperFormat[4] = new tPaperFormatType("Литера", 216, 280);             // Letter
      g_tPaperFormat[5] = new tPaperFormatType("Легальный", 216, 356);              // Legal
...
function extensionselect(sextension, bcheckuserdialog)
{
  ...
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 170, "Отчет");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "Невозможно создать отчет с выбранными параметрами разметки.");
  userdialog.Text(10, 25, 460, 15, "Выберите новую опцию. Нажмите ОК для завершения выбора.");
  userdialog.GroupBox(7, 50, 686, 85, "Параметры вывода");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "Текст в формате RTF (*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "Файл HTML (*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "Текстовый файл (*.txt)");
  userdialog.OptionButton(20, 110, 580, 15, "Документ Word (*.doc)");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function changeexgraph(g_ooutfile, bcheckuserdialog)
{
  ...
  var sextension = ""; 
  var sfilestring = ""; 
  var userdialog = Dialogs.createNewDialogTemplate(0, 0, 700, 152, "Отчет");
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "Невозможно создать отчет с графикой при данных выбранных параметрах разметки.");
  userdialog.Text(10, 25, 460, 15, "Выберите новую опцию. Нажмите ОК для завершения выбора.");
  userdialog.GroupBox(7, 50, 686, 67, "Параметры вывода");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "Текст в формате RTF (*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "Файл HTML (*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "Документ Word (*.doc)");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function outstatistic(omodels, srulenamelist, sobjstring, nstatistic, outputObject, nsemloc)
{
  ...
  while (nstart <= nmodelcount) {
    ...
    outputObject.TableCell((("Правило/" + sobjstring) + " Номер"), nfirstcellwidth, "Arial", 12, 0, 8421504, 0, 137, 0);
  ...
  // tablehead
  outputObject.TableRow();
  outputObject.TableCell((sobjstring + " Номер"), 10, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("Имя", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("Тип", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("Группа", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  // tablebody
  ...
  outputObject.EndTable(("Статистика " + sobjstring), 100, "Arial", 10, 0, - 1, 0, 136, 0);
}
...
function setReportHeaderFooterWithTitle(outfile, nloc, bDisplayServer, bDisplayDatabase, bDisplayUser, sTitle)  // BLUE-11195
{
    ...
    outfile.TableCell("", 26, "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_CENTER | Constants.FMT_VCENTER, 0);
    outfile.Output("Страница ", "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER, 0);
    outfile.OutputField(Constants.FIELD_PAGE, "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER);
    outfile.Output(" из ", "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER, 0);
    ...
    if(bDisplayServer)
        outfile.OutputLnF(("Сервер: " + ArisData.getActiveDatabase().ServerName()), "REPORT2");
    
    if(bDisplayDatabase)
        outfile.OutputLnF(("База данных: " + ArisData.getActiveDatabase().Name(nloc)), "REPORT2");
    
    if(bDisplayUser)
        outfile.OutputLnF(("Пользователь: " + ArisData.getActiveUser().Name(nloc)), "REPORT2");
