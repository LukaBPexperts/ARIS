...
function graphicdialogs(g_ooutfile, bcheckuserdialog)
{
  ...
  if (bcheckuserdialog.value) {
    ...
    while (binput == false) {
      var userdialog = Dialogs.createNewDialogTemplate(700, 310, "Afbeelding opmaken", "GraphicDialogsFunc_Dlg1");      
      // %GRID:10,7,1,1
      userdialog.Text(10, 10, 460, 15, "Gebruik de volgende opties om het modelgrafiek weer te geven.");
      userdialog.Text(10, 25, 460, 15, "Klik op OK om de selectie te beëindigen.");
      userdialog.GroupBox(7, 50, 686, 55, "Kleur");
      userdialog.OptionGroup("options1");
      userdialog.OptionButton(20, 65, 580, 15, "Gekleurd");
      userdialog.OptionButton(20, 80, 580, 15, "Zwart-wit");
      userdialog.GroupBox(7, 120, 686, 85, "Schaal");
      userdialog.TextBox(200, 132, 60, 20, "Text0");
      userdialog.Text(280, 135, 50, 15, " %");
      userdialog.OptionGroup("options3");
      userdialog.OptionButton(20, 135, 180, 15, "Door de gebruiker gedefinieerd");
      userdialog.OptionButton(20, 150, 80, 15, "100%");
      userdialog.OptionButton(20, 165, 580, 15, "Aan paginaformaat aanpassen");
      userdialog.OptionButton(20, 182, 660, 15, "Afdrukschaal model");
      userdialog.GroupBox(7, 220, 686, 55, "Knippen");
      userdialog.OptionGroup("options4");
      userdialog.OptionButton(20, 235, 580, 15, "Objecten bij marge knippen");
      userdialog.OptionButton(20, 250, 580, 15, "Objecten over marge heen plaatsen");
      userdialog.OKButton();
        ...
        if ( !(isNaN(dlg.getDlgText("Text0"))) ) {
          ...
          if (nscalevalue.value >= 10 && nscalevalue.value <= 400) {    // BLUE-10197 Adapted to the allowed values in Designer 
            binput = true;
                        ...
                        Dialogs.MsgBox("Geef een waarde op < 400.", 0, "Rapport");
          }

        }
        else {
                    Dialogs.MsgBox("Geef een waarde op.", 0, "Rapport");
        }
...
function GraphicDialogsFunc_Dlg3(dlgitem, action, suppvalue)
{
  ...
  switch(action) {
    case 1:
      g_tPaperFormat[0] = new tPaperFormatType("Door de gebruiker gedefinieerd", 0, 0);      // userdefined
...
function extensionselect(sextension, bcheckuserdialog)
{
  ...
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "Kan het rapport niet maken met de geselecteerde uitvoeroptie.");
  userdialog.Text(10, 25, 460, 15, "Selecteer een nieuwe. Klik op OK om de selectie te beëindigen.");
  userdialog.GroupBox(7, 50, 686, 85, "Uitvoeropties");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "RTF-indeling (*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "HTML-bestand (*.htm)");
  userdialog.OptionButton(20, 95, 580, 15, "Tekstbestand (*.txt)");
...
function changeexgraph(g_ooutfile, bcheckuserdialog)
{
  ...
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "Kan het rapport met diagram niet maken met de geselecteerde uitvoeroptie.");
  userdialog.Text(10, 25, 460, 15, "Selecteer een nieuwe. Klik op OK om de selectie te beëindigen.");
  userdialog.GroupBox(7, 50, 686, 67, "Uitvoeropties");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "RTF-indeling (*.rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "HTML-bestand (*.htm)");
...
function outstatistic(omodels, srulenamelist, sobjstring, nstatistic, outputObject, nsemloc)
{
  ...
  while (nstart <= nmodelcount) {
    ...
    outputObject.TableCell((("Regel/" + sobjstring) + " Nr."), nfirstcellwidth, "Arial", 12, 0, 8421504, 0, 137, 0);
    ...
    ssheetname = "Statistieken - Regels";
    if ((nindex > 1)) {
  ...
  // tablehead
  outputObject.TableRow();
  outputObject.TableCell((sobjstring + " Nr."), 10, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("Naam", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("Type", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  outputObject.TableCell("Groep", 30, "Arial", 12, 0, 8421504, 0, 137, 0);
  // tablebody
  ...
  outputObject.EndTable(("Statistieken - " + sobjstring), 100, "Arial", 10, 0, - 1, 0, 136, 0);
}
...
function setReportHeaderFooterWithTitle(outfile, nloc, bDisplayServer, bDisplayDatabase, bDisplayUser, sTitle)  // BLUE-11195
{
    ...
    outfile.TableCell("", 26, "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, 0, Constants.FMT_CENTER | Constants.FMT_VCENTER, 0);
    outfile.Output("Pagina ", "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER, 0);
    outfile.OutputField(Constants.FIELD_PAGE, "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER);
    outfile.Output(" van ", "Arial", 10, Constants.C_BLACK, Constants.C_TRANSPARENT, Constants.FMT_CENTER, 0);
    ...
    if(bDisplayServer)
        outfile.OutputLnF(("Server: " + ArisData.getActiveDatabase().ServerName()), "REPORT2");
    
    if(bDisplayDatabase)
        outfile.OutputLnF(("Database: " + ArisData.getActiveDatabase().Name(nloc)), "REPORT2");
    
    if(bDisplayUser)
        outfile.OutputLnF(("Gebruiker: " + ArisData.getActiveUser().Name(nloc)), "REPORT2");
